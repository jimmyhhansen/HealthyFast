# Bygger HealthyFast for PRODUKSJON (phone + watch).
# Oker automatisk byggnummeret i pubspec.yaml hver gang.
# Setter IKKE TESTER_BUILD - betalingsmuren er hard for ekte brukere.
#
# Bruk:  .\build_production.ps1
#
# Disse .aab-ene er trygge a laste opp til produksjonssporet.
...
Write-Host "PRODUKSJONSBYGG - betalingsmuren er aktiv." -ForegroundColor Magenta

# --- Bygg begge varianter UTEN testerflagget ---
...
flutter build appbundle --flavor watch --release
...
$phoneDst = Join-Path $outRoot "HealthyFast-phone-v$newBuild.aab"
$watchDst = Join-Path $outRoot "HealthyFast-watch-v$newBuild.aab"
