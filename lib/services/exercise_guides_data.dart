...
/// Bulk exercise database sourced from Free Exercise DB (public domain),
/// github.com/yuhonas/free-exercise-db — merged in as a fallback behind
/// the hand-curated guides in exercise_guides.dart so search/"add exercise"
/// rarely needs a custom entry. Generated file — do not hand-edit; see
/// scripts/ for the generator if these ever need to be refreshed.
const Map<String, Exercise> freeExerciseDbGuides = {
  '3/4 Sit-Up': Exercise(
    name: '3/4 Sit-Up',
    muscleGroup: 'Core',
    imageIds: ['3_4_Sit-Up'],
  ...
  'Adductor/Groin': Exercise(
    name: 'Adductor/Groin',
    muscleGroup: 'Legs',
    imageIds: ['Adductor_Groin'],
    steps: [
  ...
  'Advanced Kettlebell Windmill': Exercise(
    name: 'Advanced Kettlebell Windmill',
    muscleGroup: 'Core',
    imageIds: ['Advanced_Kettlebell_Windmill'],
    steps: [
  ...
  'All Fours Quad Stretch': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['All_Fours_Quad_Stretch'],
    steps: [
  ...
  'Alternate Hammer Curl': Exercise(
    name: 'Alternate Hammer Curl',
    muscleGroup: 'Arms',
    imageIds: ['Alternate_Hammer_Curl'],
    steps: [
  ...
  'Alternate Heel Touchers': Exercise(
    name: 'Alternate Heel Touchers',
    muscleGroup: 'Core',
    imageIds: ['Alternate_Heel_Touchers'],
    steps: [
  ...
  'Alternate Incline Dumbbell Curl': Exercise(
    name: 'Alternate Incline Dumbbell Curl',
    muscleGroup: 'Arms',
    imageIds: ['Alternate_Incline_Dumbbell_Curl'],
    steps: [
  ...
  'Alternate Leg Diagonal Bound': Exercise(
    name: 'Alternate Leg Diagonal Bound',
    muscleGroup: 'Legs',
    imageIds: ['Alternate_Leg_Diagonal_Bound'],
    steps: [
  ...
  'Alternating Cable Shoulder Press': Exercise(
    ...
    imageIds: ['Alternating_Cable_Shoulder_Press'],
    steps: [
  ...
  'Alternating Deltoid Raise': Exercise(
    name: 'Alternating Deltoid Raise',
    muscleGroup: 'Shoulders',
    imageIds: ['Alternating_Deltoid_Raise'],
    steps: [
  ...
  'Alternating Floor Press': Exercise(
    ...
    muscleGroup: 'Chest',
    imageIds: ['Alternating_Floor_Press'],
    steps: [
  ...
  'Alternating Hang Clean': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['Alternating_Hang_Clean'],
    steps: [
  ...
  'Alternating Kettlebell Press': Exercise(
    name: 'Alternating Kettlebell Press',
    muscleGroup: 'Shoulders',
    imageIds: ['Alternating_Kettlebell_Press'],
    steps: [
  ...
  'Alternating Kettlebell Row': Exercise(
    name: 'Alternating Kettlebell Row',
    muscleGroup: 'Back',
    imageIds: ['Alternating_Kettlebell_Row'],
    steps: [
  ...
  'Alternating Renegade Row': Exercise(
    ...
    muscleGroup: 'Back',
    imageIds: ['Alternating_Renegade_Row'],
    steps: [
  ...
  'Ankle On The Knee': Exercise(
    name: 'Ankle On The Knee',
    muscleGroup: 'Legs',
    imageIds: ['Ankle_On_The_Knee'],
    steps: [
  ...
  'Anterior Tibialis-SMR': Exercise(
    name: 'Anterior Tibialis-SMR',
    muscleGroup: 'Legs',
    imageIds: ['Anterior_Tibialis-SMR'],
    steps: [
      'Begin seated on the ground with your legs bent and your feet on the floor.',
      'Using a Muscle Roller or a rolling pin, apply pressure to the muscles on the outside of your shins. Work from just below the knee to above the ankle, pausing at points of tension for 10-30 seconds. Repeat on the other leg.',
    ],
  ),
  'Anti-Gravity Press': Exercise(
    name: 'Anti-Gravity Press',
    muscleGroup: 'Shoulders',
    imageIds: ['Anti-Gravity_Press'],
    steps: [
  ...
  'Arnold Dumbbell Press': Exercise(
    ...
    muscleGroup: 'Shoulders',
    imageIds: ['Arnold_Dumbbell_Press'],
    steps: [
  ...
  'Atlas Stone Trainer': Exercise(
    name: 'Atlas Stone Trainer',
    muscleGroup: 'Back',
    imageIds: ['Atlas_Stone_Trainer'],
    steps: [
  ...
  'Back Flyes - With Bands': Exercise(
    ...
    muscleGroup: 'Shoulders',
    imageIds: ['Back_Flyes_-_With_Bands'],
    steps: [
  ...
  'Backward Drag': Exercise(
    name: 'Backward Drag',
    muscleGroup: 'Legs',
    imageIds: ['Backward_Drag'],
    steps: [
      'Load a sled with the desired weight, attaching a rope or straps to the sled that you can hold onto.',
      'Begin the exercise by moving backwards for a given distance. Leaning back, extend through the legs for short steps to move as quickly as possible.',
    ],
  ),
  'Backward Medicine Ball Throw': Exercise(
    name: 'Backward Medicine Ball Throw',
    muscleGroup: 'Shoulders',
    imageIds: ['Backward_Medicine_Ball_Throw'],
    steps: [
  ...
  'Band Assisted Pull-Up': Exercise(
    ...
    muscleGroup: 'Back',
    imageIds: ['Band_Assisted_Pull-Up'],
    steps: [
  ...
  'Band Good Morning': Exercise(
    name: 'Band Good Morning',
    muscleGroup: 'Legs',
    imageIds: ['Band_Good_Morning'],
    steps: [
  ...
  'Band Good Morning (Pull Through)': Exercise(
    name: 'Band Good Morning (Pull Through)',
    muscleGroup: 'Legs',
    imageIds: ['Band_Good_Morning_Pull_Through'],
    steps: [
  ...
  'Band Skull Crusher': Exercise(
    name: 'Band Skull Crusher',
    muscleGroup: 'Arms',
    imageIds: ['Band_Skull_Crusher'],
    steps: [
  ...
  'Barbell Ab Rollout - On Knees': Exercise(
    ...
    muscleGroup: 'Core',
    imageIds: ['Barbell_Ab_Rollout_-_On_Knees'],
    steps: [
  ...
  'Barbell Bench Press - Medium Grip': Exercise(
  ...
  'Barbell Curls Lying Against An Incline': Exercise(
    name: 'Barbell Curls Lying Against An Incline',
    muscleGroup: 'Arms',
    imageIds: ['Barbell_Curls_Lying_Against_An_Incline'],
    steps: [
  ...
  'Barbell Full Squat': Exercise(
    name: 'Barbell Full Squat',
    muscleGroup: 'Legs',
    imageIds: ['Barbell_Full_Squat'],
    steps: [
  ...
  'Barbell Guillotine Bench Press': Exercise(
    ...
    muscleGroup: 'Chest',
    imageIds: ['Barbell_Guillotine_Bench_Press'],
    steps: [
  ...
  'Barbell Incline Bench Press - Medium Grip': Exercise(
    name: 'Barbell Incline Bench Press - Medium Grip',
    muscleGroup: 'Chest',
    imageIds: ['Barbell_Incline_Bench_Press_-_Medium_Grip'],
    steps: [
  ...
  'Barbell Incline Shoulder Raise': Exercise(
    name: 'Barbell Incline Shoulder Raise',
    muscleGroup: 'Shoulders',
    imageIds: ['Barbell_Incline_Shoulder_Raise'],
    steps: [
  ...
  'Barbell Rear Delt Row': Exercise(
    ...
    muscleGroup: 'Shoulders',
    imageIds: ['Barbell_Rear_Delt_Row'],
    steps: [
  ...
  'Barbell Rollout from Bench': Exercise(
    ...
    muscleGroup: 'Core',
    imageIds: ['Barbell_Rollout_from_Bench'],
    steps: [
  ...
  'Barbell Seated Calf Raise': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['Barbell_Seated_Calf_Raise'],
    steps: [
  ...
  'Barbell Shoulder Press': Exercise(
    ...
    muscleGroup: 'Shoulders',
    imageIds: ['Barbell_Shoulder_Press'],
    steps: [
  ...
  'Barbell Shrug Behind The Back': Exercise(
    name: 'Barbell Shrug Behind The Back',
    muscleGroup: 'Back',
    imageIds: ['Barbell_Shrug_Behind_The_Back'],
    steps: [
  ...
  'Barbell Side Split Squat': Exercise(
    name: 'Barbell Side Split Squat',
    muscleGroup: 'Legs',
    imageIds: ['Barbell_Side_Split_Squat'],
    steps: [
  ...
  'Barbell Squat To A Bench': Exercise(
    name: 'Barbell Squat To A Bench',
    muscleGroup: 'Legs',
    imageIds: ['Barbell_Squat_To_A_Bench'],
    steps: [
  ...
  'Barbell Walking Lunge': Exercise(
    name: 'Barbell Walking Lunge',
    muscleGroup: 'Legs',
    imageIds: ['Barbell_Walking_Lunge'],
    steps: [
  ...
  'Bear Crawl Sled Drags': Exercise(
    name: 'Bear Crawl Sled Drags',
    muscleGroup: 'Legs',
    imageIds: ['Bear_Crawl_Sled_Drags'],
    steps: [
  ...
  'Behind Head Chest Stretch': Exercise(
    ...
    muscleGroup: 'Chest',
    imageIds: ['Behind_Head_Chest_Stretch'],
    steps: [
  ...
  'Bench Press - Powerlifting': Exercise(
    name: 'Bench Press - Powerlifting',
    muscleGroup: 'Arms',
    imageIds: ['Bench_Press_-_Powerlifting'],
    steps: [
  ...
  'Bench Press - With Bands': Exercise(
    name: 'Bench Press - With Bands',
    muscleGroup: 'Chest',
    imageIds: ['Bench_Press_-_With_Bands'],
    steps: [
  ...
  'Bench Press with Chains': Exercise(
    name: 'Bench Press with Chains',
    muscleGroup: 'Arms',
    imageIds: ['Bench_Press_with_Chains'],
    steps: [
  ...
  'Bent-Arm Barbell Pullover': Exercise(
    ...
    muscleGroup: 'Back',
    imageIds: ['Bent-Arm_Barbell_Pullover'],
    steps: [
  ...
  'Bent-Arm Dumbbell Pullover': Exercise(
    name: 'Bent-Arm Dumbbell Pullover',
    muscleGroup: 'Chest',
    imageIds: ['Bent-Arm_Dumbbell_Pullover'],
    steps: [
  ...
  'Bent Over Dumbbell Rear Delt Raise With Head On Bench': Exercise(
    name: 'Bent Over Dumbbell Rear Delt Raise With Head On Bench',
    muscleGroup: 'Shoulders',
    imageIds: ['Bent_Over_Dumbbell_Rear_Delt_Raise_With_Head_On_Bench'],
    steps: [
  ...
  'Bent Over Low-Pulley Side Lateral': Exercise(
    name: 'Bent Over Low-Pulley Side Lateral',
    muscleGroup: 'Shoulders',
    imageIds: ['Bent_Over_Low-Pulley_Side_Lateral'],
    steps: [
  ...
  'Bent Over One-Arm Long Bar Row': Exercise(
    ...
    muscleGroup: 'Back',
    imageIds: ['Bent_Over_One-Arm_Long_Bar_Row'],
    steps: [
  ...
  'Bent Over Two-Arm Long Bar Row': Exercise(
    ...
    muscleGroup: 'Back',
    imageIds: ['Bent_Over_Two-Arm_Long_Bar_Row'],
    steps: [
      'Put weight on one of the ends of an Olympic barbell. Make sure that you either place the other end of the barbell in the corner of two walls; or put a heavy object on the ground so the barbell cannot slide backward.',
      'Bend forward until your torso is as close to parallel with the floor as you can and keep your knees slightly bent.',
  ...
  'Bent Over Two-Dumbbell Row': Exercise(
    ...
    muscleGroup: 'Back',
    imageIds: ['Bent_Over_Two-Dumbbell_Row'],
    steps: [
  ...
  'Bent Over Two-Dumbbell Row With Palms In': Exercise(
    name: 'Bent Over Two-Dumbbell Row With Palms In',
    muscleGroup: 'Back',
    imageIds: ['Bent_Over_Two-Dumbbell_Row_With_Palms_In'],
    steps: [
  ...
  'Bicycling, Stationary': Exercise(
    name: 'Bicycling, Stationary',
    muscleGroup: 'Legs',
    imageIds: ['Bicycling_Stationary'],
    steps: [
      'To begin, seat yourself on the bike and adjust the seat to your height.',
  ...
  'Bodyweight Mid Row': Exercise(
    name: 'Bodyweight Mid Row',
    muscleGroup: 'Back',
    imageIds: ['Bodyweight_Mid_Row'],
    steps: [
  ...
  'Bodyweight Walking Lunge': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['Bodyweight_Walking_Lunge'],
    steps: [
  ...
  'Bosu Ball Cable Crunch With Side Bends': Exercise(
    ...
    muscleGroup: 'Core',
    imageIds: ['Bosu_Ball_Cable_Crunch_With_Side_Bends'],
    steps: [
  ...
  'Bottoms-Up Clean From The Hang Position': Exercise(
    name: 'Bottoms-Up Clean From The Hang Position',
    muscleGroup: 'Arms',
    imageIds: ['Bottoms-Up_Clean_From_The_Hang_Position'],
    steps: [
  ...
  'Box Jump (Multiple Response)': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['Box_Jump_Multiple_Response'],
    steps: [
  ...
  'Box Squat with Chains': Exercise(
    name: 'Box Squat with Chains',
    muscleGroup: 'Legs',
    imageIds: ['Box_Squat_with_Chains'],
    steps: [
  ...
  'Bradford/Rocky Presses': Exercise(
    name: 'Bradford/Rocky Presses',
    muscleGroup: 'Shoulders',
    imageIds: ['Bradford_Rocky_Presses'],
    steps: [
  ...
  'Cable Hammer Curls - Rope Attachment': Exercise(
    ...
    muscleGroup: 'Arms',
    imageIds: ['Cable_Hammer_Curls_-_Rope_Attachment'],
    steps: [
  ...
  'Cable Incline Pushdown': Exercise(
    ...
    muscleGroup: 'Back',
    imageIds: ['Cable_Incline_Pushdown'],
    steps: [
  ...
  'Cable Incline Triceps Extension': Exercise(
    ...
    muscleGroup: 'Arms',
    imageIds: ['Cable_Incline_Triceps_Extension'],
    steps: [
      'Lie on incline an bench facing away from a high pulley machine that has a straight bar attachment on it.',
  ...
  'Cable Internal Rotation': Exercise(
    ...
    muscleGroup: 'Shoulders',
    imageIds: ['Cable_Internal_Rotation'],
    steps: [
  ...
  'Cable Lying Triceps Extension': Exercise(
    name: 'Cable Lying Triceps Extension',
    muscleGroup: 'Arms',
    imageIds: ['Cable_Lying_Triceps_Extension'],
    steps: [
  ...
  'Cable One Arm Tricep Extension': Exercise(
    ...
    muscleGroup: 'Arms',
    imageIds: ['Cable_One_Arm_Tricep_Extension'],
    steps: [
  ...
  'Cable Rope Overhead Triceps Extension': Exercise(
    ...
    muscleGroup: 'Arms',
    imageIds: ['Cable_Rope_Overhead_Triceps_Extension'],
    steps: [
  ...
  'Cable Rope Rear-Delt Rows': Exercise(
    ...
    muscleGroup: 'Shoulders',
    imageIds: ['Cable_Rope_Rear-Delt_Rows'],
    steps: [
  ...
  'Cable Seated Lateral Raise': Exercise(
    ...
    muscleGroup: 'Shoulders',
    imageIds: ['Cable_Seated_Lateral_Raise'],
    steps: [
  ...
  'Calf-Machine Shoulder Shrug': Exercise(
    ...
    muscleGroup: 'Back',
    imageIds: ['Calf-Machine_Shoulder_Shrug'],
    steps: [
  ...
  'Calf Press On The Leg Press Machine': Exercise(
    name: 'Calf Press On The Leg Press Machine',
    muscleGroup: 'Legs',
    imageIds: ['Calf_Press_On_The_Leg_Press_Machine'],
    steps: [
  ...
  'Calf Raise On A Dumbbell': Exercise(
    name: 'Calf Raise On A Dumbbell',
    muscleGroup: 'Legs',
    imageIds: ['Calf_Raise_On_A_Dumbbell'],
    steps: [
  ...
  'Calf Raises - With Bands': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['Calf_Raises_-_With_Bands'],
    steps: [
  ...
  'Calf Stretch Elbows Against Wall': Exercise(
    name: 'Calf Stretch Elbows Against Wall',
    muscleGroup: 'Legs',
    imageIds: ['Calf_Stretch_Elbows_Against_Wall'],
    steps: [
  ...
  'Calf Stretch Hands Against Wall': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['Calf_Stretch_Hands_Against_Wall'],
    steps: [
  ...
  'Carioca Quick Step': Exercise(
    name: 'Carioca Quick Step',
    muscleGroup: 'Legs',
    imageIds: ['Carioca_Quick_Step'],
    steps: [
  ...
  'Catch and Overhead Throw': Exercise(
    name: 'Catch and Overhead Throw',
    muscleGroup: 'Back',
    imageIds: ['Catch_and_Overhead_Throw'],
    steps: [
  ...
  'Chain Handle Extension': Exercise(
    name: 'Chain Handle Extension',
    muscleGroup: 'Arms',
    imageIds: ['Chain_Handle_Extension'],
    steps: [
  ...
  'Chain Press': Exercise(
    name: 'Chain Press',
    muscleGroup: 'Chest',
    imageIds: ['Chain_Press'],
    steps: [
  ...
  'Chair Leg Extended Stretch': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['Chair_Leg_Extended_Stretch'],
    steps: [
  ...
  'Chair Lower Back Stretch': Exercise(
    ...
    muscleGroup: 'Back',
    imageIds: ['Chair_Lower_Back_Stretch'],
    steps: [
  ...
  'Chair Upper Body Stretch': Exercise(
    name: 'Chair Upper Body Stretch',
    muscleGroup: 'Shoulders',
    imageIds: ['Chair_Upper_Body_Stretch'],
    steps: [
  ...
  'Chest And Front Of Shoulder Stretch': Exercise(
    ...
    muscleGroup: 'Chest',
    imageIds: ['Chest_And_Front_Of_Shoulder_Stretch'],
    steps: [
  ...
  'Chest Push from 3 point stance': Exercise(
    name: 'Chest Push from 3 point stance',
    muscleGroup: 'Chest',
    imageIds: ['Chest_Push_from_3_point_stance'],
    steps: [
  ...
  'Chest Push (multiple response)': Exercise(
    name: 'Chest Push (multiple response)',
    muscleGroup: 'Chest',
    imageIds: ['Chest_Push_multiple_response'],
    steps: [
  ...
  'Chest Push (single response)': Exercise(
    name: 'Chest Push (single response)',
    muscleGroup: 'Chest',
    imageIds: ['Chest_Push_single_response'],
    steps: [
  ...
  'Chest Push with Run Release': Exercise(
    ...
    muscleGroup: 'Chest',
    imageIds: ['Chest_Push_with_Run_Release'],
    steps: [
  ...
  'Chest Stretch on Stability Ball': Exercise(
    name: 'Chest Stretch on Stability Ball',
    muscleGroup: 'Chest',
    imageIds: ['Chest_Stretch_on_Stability_Ball'],
    steps: [
  ...
  'Chin To Chest Stretch': Exercise(
    name: 'Chin To Chest Stretch',
    muscleGroup: 'Other',
    imageIds: ['Chin_To_Chest_Stretch'],
    steps: [
  ...
  'Circus Bell': Exercise(
    name: 'Circus Bell',
    muscleGroup: 'Shoulders',
    imageIds: ['Circus_Bell'],
    steps: [
  ...
  'Clean Shrug': Exercise(
    name: 'Clean Shrug',
    muscleGroup: 'Back',
    imageIds: ['Clean_Shrug'],
    steps: [
  ...
  'Close-Grip Barbell Bench Press': Exercise(
    name: 'Close-Grip Barbell Bench Press',
    muscleGroup: 'Arms',
    imageIds: ['Close-Grip_Barbell_Bench_Press'],
    steps: [
  ...
  'Close-Grip Dumbbell Press': Exercise(
    name: 'Close-Grip Dumbbell Press',
    muscleGroup: 'Arms',
    imageIds: ['Close-Grip_Dumbbell_Press'],
    steps: [
      'Place a dumbbell standing up on a flat bench.',
  ...
  'Close-Grip EZ-Bar Curl with Band': Exercise(
    name: 'Close-Grip EZ-Bar Curl with Band',
    muscleGroup: 'Arms',
    imageIds: ['Close-Grip_EZ-Bar_Curl_with_Band'],
    steps: [
  ...
  'Close-Grip EZ-Bar Press': Exercise(
    name: 'Close-Grip EZ-Bar Press',
    muscleGroup: 'Arms',
    imageIds: ['Close-Grip_EZ-Bar_Press'],
    steps: [
  ...
  'Close-Grip EZ Bar Curl': Exercise(
    ...
    muscleGroup: 'Arms',
    imageIds: ['Close-Grip_EZ_Bar_Curl'],
    steps: [
  ...
  'Close-Grip Front Lat Pulldown': Exercise(
    name: 'Close-Grip Front Lat Pulldown',
    muscleGroup: 'Back',
    imageIds: ['Close-Grip_Front_Lat_Pulldown'],
    steps: [
  ...
  'Close-Grip Push-Up off of a Dumbbell': Exercise(
    name: 'Close-Grip Push-Up off of a Dumbbell',
    muscleGroup: 'Arms',
    imageIds: ['Close-Grip_Push-Up_off_of_a_Dumbbell'],
    steps: [
  ...
  'Close-Grip Standing Barbell Curl': Exercise(
    name: 'Close-Grip Standing Barbell Curl',
    muscleGroup: 'Arms',
    imageIds: ['Close-Grip_Standing_Barbell_Curl'],
    steps: [
  ...
  'Conan\'s Wheel': Exercise(
    name: 'Conan\'s Wheel',
    muscleGroup: 'Legs',
    imageIds: ['Conans_Wheel'],
    steps: [
  ...
  'Cross Body Hammer Curl': Exercise(
    ...
    muscleGroup: 'Arms',
    imageIds: ['Cross_Body_Hammer_Curl'],
    steps: [
  ...
  'Cross Over - With Bands': Exercise(
    name: 'Cross Over - With Bands',
    muscleGroup: 'Chest',
    imageIds: ['Cross_Over_-_With_Bands'],
    steps: [
  ...
  'Crossover Reverse Lunge': Exercise(
    name: 'Crossover Reverse Lunge',
    muscleGroup: 'Back',
    imageIds: ['Crossover_Reverse_Lunge'],
    steps: [
  ...
  'Crunch - Hands Overhead': Exercise(
    ...
    muscleGroup: 'Core',
    imageIds: ['Crunch_-_Hands_Overhead'],
    steps: [
  ...
  'Crunch - Legs On Exercise Ball': Exercise(
    ...
    muscleGroup: 'Core',
    imageIds: ['Crunch_-_Legs_On_Exercise_Ball'],
    steps: [
  ...
  'Deadlift with Bands': Exercise(
    name: 'Deadlift with Bands',
    muscleGroup: 'Back',
    imageIds: ['Deadlift_with_Bands'],
    steps: [
  ...
  'Deadlift with Chains': Exercise(
    name: 'Deadlift with Chains',
    muscleGroup: 'Back',
    imageIds: ['Deadlift_with_Chains'],
    steps: [
  ...
  'Decline Barbell Bench Press': Exercise(
    ...
    muscleGroup: 'Chest',
    imageIds: ['Decline_Barbell_Bench_Press'],
    steps: [
  ...
  'Decline Close-Grip Bench To Skull Crusher': Exercise(
    ...
    muscleGroup: 'Arms',
    imageIds: ['Decline_Close-Grip_Bench_To_Skull_Crusher'],
    steps: [
      'Secure your legs at the end of the decline bench and slowly lay down on the bench.',
  ...
  'Decline Dumbbell Bench Press': Exercise(
    ...
    muscleGroup: 'Chest',
    imageIds: ['Decline_Dumbbell_Bench_Press'],
    steps: [
  ...
  'Decline Dumbbell Flyes': Exercise(
    name: 'Decline Dumbbell Flyes',
    muscleGroup: 'Chest',
    imageIds: ['Decline_Dumbbell_Flyes'],
    steps: [
      'Secure your legs at the end of the decline bench and lie down with a dumbbell on each hand on top of your thighs. The palms of your hand will be facing each other.',
  ...
  'Decline Dumbbell Triceps Extension': Exercise(
    name: 'Decline Dumbbell Triceps Extension',
    muscleGroup: 'Arms',
    imageIds: ['Decline_Dumbbell_Triceps_Extension'],
    steps: [
      'Secure your legs at the end of the decline bench and lie down with a dumbbell on each hand on top of your thighs. The palms of your hand will be facing each other.',
      'Once you are laying down, move the dumbbells in front of you at shoulder width. The palms of the hands should be facing each other and the arms should be perpendicular to the floor and fully extended. This will be your starting position.',
  ...
  'Decline EZ Bar Triceps Extension': Exercise(
    name: 'Decline EZ Bar Triceps Extension',
    muscleGroup: 'Arms',
    imageIds: ['Decline_EZ_Bar_Triceps_Extension'],
    steps: [
      'Secure your legs at the end of the decline bench and slowly lay down on the bench.',
  ...
  'Decline Oblique Crunch': Exercise(
    ...
    muscleGroup: 'Core',
    imageIds: ['Decline_Oblique_Crunch'],
    steps: [
      'Secure your legs at the end of the decline bench and slowly lay down on the bench.',
  ...
  'Decline Reverse Crunch': Exercise(
    ...
    muscleGroup: 'Core',
    imageIds: ['Decline_Reverse_Crunch'],
    steps: [
  ...
  'Decline Smith Press': Exercise(
    name: 'Decline Smith Press',
    muscleGroup: 'Chest',
    imageIds: ['Decline_Smith_Press'],
    steps: [
  ...
  'Dips - Chest Version': Exercise(
    name: 'Dips - Chest Version',
    muscleGroup: 'Chest',
    imageIds: ['Dips_-_Chest_Version'],
    steps: [
  ...
  'Dips - Triceps Version': Exercise(
    name: 'Dips - Triceps Version',
    muscleGroup: 'Arms',
    imageIds: ['Dips_-_Triceps_Version'],
    steps: [
  ...
  'Double Kettlebell Alternating Hang Clean': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['Double_Kettlebell_Alternating_Hang_Clean'],
    steps: [
      'Place two kettlebells between your feet. To get in the starting position, push your butt back and look straight ahead.',
  ...
  'Double Kettlebell Jerk': Exercise(
    ...
    muscleGroup: 'Shoulders',
    imageIds: ['Double_Kettlebell_Jerk'],
    steps: [
  ...
  'Double Kettlebell Push Press': Exercise(
    ...
    muscleGroup: 'Shoulders',
    imageIds: ['Double_Kettlebell_Push_Press'],
    steps: [
  ...
  'Double Kettlebell Snatch': Exercise(
    ...
    muscleGroup: 'Shoulders',
    imageIds: ['Double_Kettlebell_Snatch'],
    steps: [
  ...
  'Double Kettlebell Windmill': Exercise(
    ...
    muscleGroup: 'Core',
    imageIds: ['Double_Kettlebell_Windmill'],
    steps: [
  ...
  'Downward Facing Balance': Exercise(
    name: 'Downward Facing Balance',
    muscleGroup: 'Legs',
    imageIds: ['Downward_Facing_Balance'],
    steps: [
  ...
  'Dumbbell Alternate Bicep Curl': Exercise(
    name: 'Dumbbell Alternate Bicep Curl',
    muscleGroup: 'Arms',
    imageIds: ['Dumbbell_Alternate_Bicep_Curl'],
    steps: [
  ...
  'Dumbbell Bench Press with Neutral Grip': Exercise(
    name: 'Dumbbell Bench Press with Neutral Grip',
    muscleGroup: 'Chest',
    imageIds: ['Dumbbell_Bench_Press_with_Neutral_Grip'],
    steps: [
  ...
  'Dumbbell Incline Shoulder Raise': Exercise(
    name: 'Dumbbell Incline Shoulder Raise',
    muscleGroup: 'Shoulders',
    imageIds: ['Dumbbell_Incline_Shoulder_Raise'],
    steps: [
  ...
  'Dumbbell Lying One-Arm Rear Lateral Raise': Exercise(
    name: 'Dumbbell Lying One-Arm Rear Lateral Raise',
    muscleGroup: 'Shoulders',
    imageIds: ['Dumbbell_Lying_One-Arm_Rear_Lateral_Raise'],
    steps: [
  ...
  'Dumbbell Lying Pronation': Exercise(
    name: 'Dumbbell Lying Pronation',
    muscleGroup: 'Arms',
    imageIds: ['Dumbbell_Lying_Pronation'],
    steps: [
  ...
  'Dumbbell Lying Rear Lateral Raise': Exercise(
    ...
    muscleGroup: 'Shoulders',
    imageIds: ['Dumbbell_Lying_Rear_Lateral_Raise'],
    steps: [
  ...
  'Dumbbell Lying Supination': Exercise(
    name: 'Dumbbell Lying Supination',
    muscleGroup: 'Arms',
    imageIds: ['Dumbbell_Lying_Supination'],
    steps: [
  ...
  'Dumbbell One-Arm Shoulder Press': Exercise(
    name: 'Dumbbell One-Arm Shoulder Press',
    muscleGroup: 'Shoulders',
    imageIds: ['Dumbbell_One-Arm_Shoulder_Press'],
    steps: [
  ...
  'Dumbbell One-Arm Triceps Extension': Exercise(
    name: 'Dumbbell One-Arm Triceps Extension',
    muscleGroup: 'Arms',
    imageIds: ['Dumbbell_One-Arm_Triceps_Extension'],
    steps: [
      'Grab a dumbbell and either sit on a military press bench or a utility bench that has a back support on it as you place the dumbbells upright on top of your thighs or stand up straight.',
  ...
  'Dumbbell One-Arm Upright Row': Exercise(
    ...
    muscleGroup: 'Shoulders',
    imageIds: ['Dumbbell_One-Arm_Upright_Row'],
    steps: [
  ...
  'Dumbbell Prone Incline Curl': Exercise(
    name: 'Dumbbell Prone Incline Curl',
    muscleGroup: 'Arms',
    imageIds: ['Dumbbell_Prone_Incline_Curl'],
    steps: [
  ...
  'Dumbbell Rear Lunge': Exercise(
    name: 'Dumbbell Rear Lunge',
    muscleGroup: 'Legs',
    imageIds: ['Dumbbell_Rear_Lunge'],
    steps: [
      'Stand with your torso upright holding two dumbbells in your hands by your sides. This will be your starting position.',
  ...
  'Dumbbell Seated Box Jump': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['Dumbbell_Seated_Box_Jump'],
    steps: [
  ...
  'Dumbbell Seated One-Leg Calf Raise': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['Dumbbell_Seated_One-Leg_Calf_Raise'],
    steps: [
  ...
  'Dumbbell Shoulder Press': Exercise(
    ...
    muscleGroup: 'Shoulders',
    imageIds: ['Dumbbell_Shoulder_Press'],
    steps: [
  ...
  'Dumbbell Squat To A Bench': Exercise(
    name: 'Dumbbell Squat To A Bench',
    muscleGroup: 'Legs',
    imageIds: ['Dumbbell_Squat_To_A_Bench'],
    steps: [
  ...
  'Dumbbell Tricep Extension -Pronated Grip': Exercise(
    name: 'Dumbbell Tricep Extension -Pronated Grip',
    muscleGroup: 'Arms',
    imageIds: ['Dumbbell_Tricep_Extension_-Pronated_Grip'],
    steps: [
  ...
  'Dynamic Chest Stretch': Exercise(
    ...
    muscleGroup: 'Chest',
    imageIds: ['Dynamic_Chest_Stretch'],
    steps: [
  ...
  'Elevated Back Lunge': Exercise(
    name: 'Elevated Back Lunge',
    muscleGroup: 'Legs',
    imageIds: ['Elevated_Back_Lunge'],
    steps: [
  ...
  'Elevated Cable Rows': Exercise(
    name: 'Elevated Cable Rows',
    muscleGroup: 'Back',
    imageIds: ['Elevated_Cable_Rows'],
    steps: [
  ...
  'Exercise Ball Crunch': Exercise(
    name: 'Exercise Ball Crunch',
    muscleGroup: 'Core',
    imageIds: ['Exercise_Ball_Crunch'],
    steps: [
  ...
  'Exercise Ball Pull-In': Exercise(
    name: 'Exercise Ball Pull-In',
    muscleGroup: 'Core',
    imageIds: ['Exercise_Ball_Pull-In'],
    steps: [
  ...
  'Extended Range One-Arm Kettlebell Floor Press': Exercise(
    name: 'Extended Range One-Arm Kettlebell Floor Press',
    muscleGroup: 'Chest',
    imageIds: ['Extended_Range_One-Arm_Kettlebell_Floor_Press'],
    steps: [
  ...
  'External Rotation with Band': Exercise(
    ...
    muscleGroup: 'Shoulders',
    imageIds: ['External_Rotation_with_Band'],
    steps: [
  ...
  'External Rotation with Cable': Exercise(
    name: 'External Rotation with Cable',
    muscleGroup: 'Shoulders',
    imageIds: ['External_Rotation_with_Cable'],
    steps: [
  ...
  'Flat Bench Cable Flyes': Exercise(
    ...
    muscleGroup: 'Chest',
    imageIds: ['Flat_Bench_Cable_Flyes'],
    steps: [
  ...
  'Flat Bench Leg Pull-In': Exercise(
    name: 'Flat Bench Leg Pull-In',
    muscleGroup: 'Core',
    imageIds: ['Flat_Bench_Leg_Pull-In'],
    steps: [
  ...
  'Flat Bench Lying Leg Raise': Exercise(
    name: 'Flat Bench Lying Leg Raise',
    muscleGroup: 'Core',
    imageIds: ['Flat_Bench_Lying_Leg_Raise'],
    steps: [
  ...
  'Flexor Incline Dumbbell Curls': Exercise(
    name: 'Flexor Incline Dumbbell Curls',
    muscleGroup: 'Arms',
    imageIds: ['Flexor_Incline_Dumbbell_Curls'],
    steps: [
  ...
  'Floor Glute-Ham Raise': Exercise(
    name: 'Floor Glute-Ham Raise',
    muscleGroup: 'Legs',
    imageIds: ['Floor_Glute-Ham_Raise'],
    steps: [
  ...
  'Floor Press with Chains': Exercise(
    name: 'Floor Press with Chains',
    muscleGroup: 'Arms',
    imageIds: ['Floor_Press_with_Chains'],
    steps: [
  ...
  'Forward Drag with Press': Exercise(
    name: 'Forward Drag with Press',
    muscleGroup: 'Chest',
    imageIds: ['Forward_Drag_with_Press'],
    steps: [
  ...
  'Frankenstein Squat': Exercise(
    name: 'Frankenstein Squat',
    muscleGroup: 'Legs',
    imageIds: ['Frankenstein_Squat'],
    steps: [
  ...
  'Front Barbell Squat To A Bench': Exercise(
    name: 'Front Barbell Squat To A Bench',
    muscleGroup: 'Legs',
    imageIds: ['Front_Barbell_Squat_To_A_Bench'],
    steps: [
  ...
  'Front Cone Hops (or hurdle hops)': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['Front_Cone_Hops_or_hurdle_hops'],
    steps: [
  ...
  'Front Incline Dumbbell Raise': Exercise(
    name: 'Front Incline Dumbbell Raise',
    muscleGroup: 'Shoulders',
    imageIds: ['Front_Incline_Dumbbell_Raise'],
    steps: [
  ...
  'Front Raise And Pullover': Exercise(
    ...
    muscleGroup: 'Chest',
    imageIds: ['Front_Raise_And_Pullover'],
    steps: [
  ...
  'Front Squat (Clean Grip)': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['Front_Squat_Clean_Grip'],
    steps: [
  ...
  'Front Squats With Two Kettlebells': Exercise(
    name: 'Front Squats With Two Kettlebells',
    muscleGroup: 'Legs',
    imageIds: ['Front_Squats_With_Two_Kettlebells'],
    steps: [
      'Clean two kettlebells to your shoulders. Clean the kettlebells to your shoulders by extending through the legs and hips as you pull the kettlebells towards your shoulders. Rotate your wrists as you do so.',
  ...
  'Front Two-Dumbbell Raise': Exercise(
    name: 'Front Two-Dumbbell Raise',
    muscleGroup: 'Shoulders',
    imageIds: ['Front_Two-Dumbbell_Raise'],
    steps: [
      'Pick a couple of dumbbells and stand with a straight torso and the dumbbells on front of your thighs at arms length with the palms of the hand facing your thighs. This will be your starting position.',
  ...
  'Full Range-Of-Motion Lat Pulldown': Exercise(
    name: 'Full Range-Of-Motion Lat Pulldown',
    muscleGroup: 'Back',
    imageIds: ['Full_Range-Of-Motion_Lat_Pulldown'],
    steps: [
  ...
  'Gironda Sternum Chins': Exercise(
    name: 'Gironda Sternum Chins',
    muscleGroup: 'Back',
    imageIds: ['Gironda_Sternum_Chins'],
    steps: [
  ...
  'Good Morning off Pins': Exercise(
    name: 'Good Morning off Pins',
    muscleGroup: 'Legs',
    imageIds: ['Good_Morning_off_Pins'],
    steps: [
  ...
  'Groin and Back Stretch': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['Groin_and_Back_Stretch'],
    steps: [
  ...
  'Hammer Grip Incline DB Bench Press': Exercise(
    name: 'Hammer Grip Incline DB Bench Press',
    muscleGroup: 'Chest',
    imageIds: ['Hammer_Grip_Incline_DB_Bench_Press'],
    steps: [
  ...
  'Hamstring-SMR': Exercise(
    name: 'Hamstring-SMR',
    muscleGroup: 'Legs',
    imageIds: ['Hamstring-SMR'],
    steps: [
  ...
  'Handstand Push-Ups': Exercise(
    name: 'Handstand Push-Ups',
    muscleGroup: 'Shoulders',
    imageIds: ['Handstand_Push-Ups'],
    steps: [
  ...
  'Hang Clean - Below the Knees': Exercise(
    name: 'Hang Clean - Below the Knees',
    muscleGroup: 'Legs',
    imageIds: ['Hang_Clean_-_Below_the_Knees'],
    steps: [
  ...
  'Hang Snatch - Below Knees': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['Hang_Snatch_-_Below_Knees'],
    steps: [
  ...
  'Hanging Bar Good Morning': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['Hanging_Bar_Good_Morning'],
    steps: [
  ...
  'Heaving Snatch Balance': Exercise(
    name: 'Heaving Snatch Balance',
    muscleGroup: 'Legs',
    imageIds: ['Heaving_Snatch_Balance'],
    steps: [
  ...
  'Hip Extension with Bands': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['Hip_Extension_with_Bands'],
    steps: [
  ...
  'Hip Flexion with Band': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['Hip_Flexion_with_Band'],
    steps: [
      'Secure one end of the band to the lower portion of a post and attach the other to one ankle.',
  ...
  'Hip Lift with Band': Exercise(
    name: 'Hip Lift with Band',
    muscleGroup: 'Legs',
    imageIds: ['Hip_Lift_with_Band'],
    steps: [
  ...
  'Hyperextensions (Back Extensions)': Exercise(
    name: 'Hyperextensions (Back Extensions)',
    muscleGroup: 'Back',
    imageIds: ['Hyperextensions_Back_Extensions'],
    steps: [
  ...
  'Hyperextensions With No Hyperextension Bench': Exercise(
    ...
    muscleGroup: 'Back',
    imageIds: ['Hyperextensions_With_No_Hyperextension_Bench'],
    steps: [
  ...
  'IT Band and Glute Stretch': Exercise(
    name: 'IT Band and Glute Stretch',
    muscleGroup: 'Legs',
    imageIds: ['IT_Band_and_Glute_Stretch'],
    steps: [
  ...
  'Iliotibial Tract-SMR': Exercise(
    name: 'Iliotibial Tract-SMR',
    muscleGroup: 'Legs',
    imageIds: ['Iliotibial_Tract-SMR'],
    steps: [
  ...
  'Incline Barbell Triceps Extension': Exercise(
    ...
    muscleGroup: 'Arms',
    imageIds: ['Incline_Barbell_Triceps_Extension'],
    steps: [
  ...
  'Incline Cable Chest Press': Exercise(
    name: 'Incline Cable Chest Press',
    muscleGroup: 'Chest',
    imageIds: ['Incline_Cable_Chest_Press'],
    steps: [
      'Adjust the weight to an appropriate amount and be seated, grasping the handles. Your upper arms should be about 45 degrees to the body, with your head and chest up. The elbows should be bent to about 90 degrees. This will be your starting position.',
      'Begin by extending through the elbow, pressing the handles together straight in front of you. Keep your shoulder blades retracted as you execute the movement.',
  ...
  'Incline Dumbbell Bench With Palms Facing In': Exercise(
    ...
    muscleGroup: 'Chest',
    imageIds: ['Incline_Dumbbell_Bench_With_Palms_Facing_In'],
    steps: [
      'Lie back on an incline bench with a dumbbell on each hand on top of your thighs. The palms of your hand will be facing each other.',
      'By using your thighs to help you get the dumbbells up, clean the dumbbells one arm at a time so that you can hold them at shoulder width.',
      'Once at shoulder width, keep the palms of your hands with a neutral grip (palms facing each other). Keep your elbows flared out with the upper arms in line with the shoulders (perpendicular to the torso) and the elbows bent creating a 90-degree angle between the upper arm and the forearm. This will be your starting position.',
  ...
  'Incline Dumbbell Curl': Exercise(
    ...
    muscleGroup: 'Arms',
    imageIds: ['Incline_Dumbbell_Curl'],
    steps: [
  ...
  'Incline Dumbbell Flyes': Exercise(
    ...
    muscleGroup: 'Chest',
    imageIds: ['Incline_Dumbbell_Flyes'],
    steps: [
  ...
  'Incline Dumbbell Flyes - With A Twist': Exercise(
    name: 'Incline Dumbbell Flyes - With A Twist',
    muscleGroup: 'Chest',
    imageIds: ['Incline_Dumbbell_Flyes_-_With_A_Twist'],
    steps: [
  ...
  'Incline Inner Biceps Curl': Exercise(
    ...
    muscleGroup: 'Arms',
    imageIds: ['Incline_Inner_Biceps_Curl'],
    steps: [
  ...
  'Incline Push-Up Close-Grip': Exercise(
    name: 'Incline Push-Up Close-Grip',
    muscleGroup: 'Arms',
    imageIds: ['Incline_Push-Up_Close-Grip'],
    steps: [
  ...
  'Incline Push-Up Depth Jump': Exercise(
    name: 'Incline Push-Up Depth Jump',
    muscleGroup: 'Chest',
    imageIds: ['Incline_Push-Up_Depth_Jump'],
    steps: [
  ...
  'Incline Push-Up Medium': Exercise(
    name: 'Incline Push-Up Medium',
    muscleGroup: 'Chest',
    imageIds: ['Incline_Push-Up_Medium'],
    steps: [
      'Stand facing a Smith machine bar or sturdy elevated platform at an appropriate height.',
  ...
  'Incline Push-Up Reverse Grip': Exercise(
    name: 'Incline Push-Up Reverse Grip',
    muscleGroup: 'Chest',
    imageIds: ['Incline_Push-Up_Reverse_Grip'],
    steps: [
      'Stand facing a Smith machine bar or sturdy elevated platform at an appropriate height.',
  ...
  'Intermediate Groin Stretch': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['Intermediate_Groin_Stretch'],
    steps: [
  ...
  'Intermediate Hip Flexor and Quad Stretch': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['Intermediate_Hip_Flexor_and_Quad_Stretch'],
    steps: [
  ...
  'Internal Rotation with Band': Exercise(
    ...
    muscleGroup: 'Shoulders',
    imageIds: ['Internal_Rotation_with_Band'],
    steps: [
  ...
  'Inverted Row with Straps': Exercise(
    ...
    muscleGroup: 'Back',
    imageIds: ['Inverted_Row_with_Straps'],
    steps: [
  ...
  'Isometric Chest Squeezes': Exercise(
    name: 'Isometric Chest Squeezes',
    muscleGroup: 'Chest',
    imageIds: ['Isometric_Chest_Squeezes'],
    steps: [
  ...
  'Isometric Neck Exercise - Front And Back': Exercise(
    name: 'Isometric Neck Exercise - Front And Back',
    muscleGroup: 'Other',
    imageIds: ['Isometric_Neck_Exercise_-_Front_And_Back'],
    steps: [
  ...
  'Isometric Neck Exercise - Sides': Exercise(
    ...
    muscleGroup: 'Other',
    imageIds: ['Isometric_Neck_Exercise_-_Sides'],
    steps: [
  ...
  'Jerk Balance': Exercise(
    name: 'Jerk Balance',
    muscleGroup: 'Shoulders',
    imageIds: ['Jerk_Balance'],
    steps: [
  ...
  'Jerk Dip Squat': Exercise(
    name: 'Jerk Dip Squat',
    muscleGroup: 'Legs',
    imageIds: ['Jerk_Dip_Squat'],
    steps: [
  ...
  'Kettlebell Arnold Press': Exercise(
    name: 'Kettlebell Arnold Press',
    muscleGroup: 'Shoulders',
    imageIds: ['Kettlebell_Arnold_Press'],
    steps: [
  ...
  'Kettlebell Dead Clean': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['Kettlebell_Dead_Clean'],
    steps: [
  ...
  'Kettlebell Figure 8': Exercise(
    name: 'Kettlebell Figure 8',
    muscleGroup: 'Core',
    imageIds: ['Kettlebell_Figure_8'],
    steps: [
  ...
  'Kettlebell Hang Clean': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['Kettlebell_Hang_Clean'],
    steps: [
      'Place kettlebell between your feet. To get in the starting position, push your butt back and look straight ahead.',
  ...
  'Kettlebell One-Legged Deadlift': Exercise(
    name: 'Kettlebell One-Legged Deadlift',
    muscleGroup: 'Legs',
    imageIds: ['Kettlebell_One-Legged_Deadlift'],
    steps: [
  ...
  'Kettlebell Pass Between The Legs': Exercise(
    ...
    muscleGroup: 'Core',
    imageIds: ['Kettlebell_Pass_Between_The_Legs'],
    steps: [
  ...
  'Kettlebell Pirate Ships': Exercise(
    ...
    muscleGroup: 'Shoulders',
    imageIds: ['Kettlebell_Pirate_Ships'],
    steps: [
  ...
  'Kettlebell Pistol Squat': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['Kettlebell_Pistol_Squat'],
    steps: [
  ...
  'Kettlebell Seated Press': Exercise(
    name: 'Kettlebell Seated Press',
    muscleGroup: 'Shoulders',
    imageIds: ['Kettlebell_Seated_Press'],
    steps: [
  ...
  'Kettlebell Seesaw Press': Exercise(
    ...
    muscleGroup: 'Shoulders',
    imageIds: ['Kettlebell_Seesaw_Press'],
    steps: [
  ...
  'Kettlebell Sumo High Pull': Exercise(
    name: 'Kettlebell Sumo High Pull',
    muscleGroup: 'Back',
    imageIds: ['Kettlebell_Sumo_High_Pull'],
    steps: [
  ...
  'Kettlebell Turkish Get-Up (Lunge style)': Exercise(
    name: 'Kettlebell Turkish Get-Up (Lunge style)',
    muscleGroup: 'Shoulders',
    imageIds: ['Kettlebell_Turkish_Get-Up_Lunge_style'],
    steps: [
  ...
  'Kettlebell Turkish Get-Up (Squat style)': Exercise(
    name: 'Kettlebell Turkish Get-Up (Squat style)',
    muscleGroup: 'Shoulders',
    imageIds: ['Kettlebell_Turkish_Get-Up_Squat_style'],
    steps: [
      'Lie on your back on the floor and press a kettlebell to the top position by extending the elbow. Bend the knee on the same side as the kettlebell.',
  ...
  'Kipping Muscle Up': Exercise(
    name: 'Kipping Muscle Up',
    muscleGroup: 'Back',
    imageIds: ['Kipping_Muscle_Up'],
    steps: [
  ...
  'Knee Across The Body': Exercise(
    name: 'Knee Across The Body',
    muscleGroup: 'Legs',
    imageIds: ['Knee_Across_The_Body'],
    steps: [
  ...
  'Knee/Hip Raise On Parallel Bars': Exercise(
    ...
    muscleGroup: 'Core',
    imageIds: ['Knee_Hip_Raise_On_Parallel_Bars'],
    steps: [
  ...
  'Kneeling Arm Drill': Exercise(
    name: 'Kneeling Arm Drill',
    muscleGroup: 'Shoulders',
    imageIds: ['Kneeling_Arm_Drill'],
    steps: [
  ...
  'Kneeling Cable Crunch With Alternating Oblique Twists': Exercise(
    ...
    muscleGroup: 'Core',
    imageIds: ['Kneeling_Cable_Crunch_With_Alternating_Oblique_Twists'],
    steps: [
  ...
  'Kneeling Cable Triceps Extension': Exercise(
    ...
    muscleGroup: 'Arms',
    imageIds: ['Kneeling_Cable_Triceps_Extension'],
    steps: [
  ...
  'Kneeling Forearm Stretch': Exercise(
    ...
    muscleGroup: 'Arms',
    imageIds: ['Kneeling_Forearm_Stretch'],
    steps: [
  ...
  'Kneeling High Pulley Row': Exercise(
    name: 'Kneeling High Pulley Row',
    muscleGroup: 'Back',
    imageIds: ['Kneeling_High_Pulley_Row'],
    steps: [
  ...
  'Kneeling Single-Arm High Pulley Row': Exercise(
    name: 'Kneeling Single-Arm High Pulley Row',
    muscleGroup: 'Back',
    imageIds: ['Kneeling_Single-Arm_High_Pulley_Row'],
    steps: [
  ...
  'Landmine 180\'s': Exercise(
    name: 'Landmine 180\'s',
    muscleGroup: 'Core',
    imageIds: ['Landmine_180s'],
    steps: [
  ...
  'Landmine Linear Jammer': Exercise(
    name: 'Landmine Linear Jammer',
    muscleGroup: 'Shoulders',
    imageIds: ['Landmine_Linear_Jammer'],
    steps: [
  ...
  'Lateral Raise - With Bands': Exercise(
    name: 'Lateral Raise - With Bands',
    muscleGroup: 'Shoulders',
    imageIds: ['Lateral_Raise_-_With_Bands'],
    steps: [
  ...
  'Latissimus Dorsi-SMR': Exercise(
    name: 'Latissimus Dorsi-SMR',
    muscleGroup: 'Back',
    imageIds: ['Latissimus_Dorsi-SMR'],
    steps: [
  ...
  'Leg-Over Floor Press': Exercise(
    name: 'Leg-Over Floor Press',
    muscleGroup: 'Chest',
    imageIds: ['Leg-Over_Floor_Press'],
    steps: [
  ...
  'Leg-Up Hamstring Stretch': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['Leg-Up_Hamstring_Stretch'],
    steps: [
  ...
  'Leverage Chest Press': Exercise(
    name: 'Leverage Chest Press',
    muscleGroup: 'Chest',
    imageIds: ['Leverage_Chest_Press'],
    steps: [
  ...
  'Leverage Deadlift': Exercise(
    name: 'Leverage Deadlift',
    muscleGroup: 'Legs',
    imageIds: ['Leverage_Deadlift'],
    steps: [
  ...
  'Leverage Decline Chest Press': Exercise(
    name: 'Leverage Decline Chest Press',
    muscleGroup: 'Chest',
    imageIds: ['Leverage_Decline_Chest_Press'],
    steps: [
  ...
  'Leverage High Row': Exercise(
    name: 'Leverage High Row',
    muscleGroup: 'Back',
    imageIds: ['Leverage_High_Row'],
    steps: [
  ...
  'Leverage Incline Chest Press': Exercise(
    name: 'Leverage Incline Chest Press',
    muscleGroup: 'Chest',
    imageIds: ['Leverage_Incline_Chest_Press'],
    steps: [
  ...
  'Leverage Iso Row': Exercise(
    name: 'Leverage Iso Row',
    muscleGroup: 'Back',
    imageIds: ['Leverage_Iso_Row'],
    steps: [
  ...
  'Leverage Shoulder Press': Exercise(
    ...
    muscleGroup: 'Shoulders',
    imageIds: ['Leverage_Shoulder_Press'],
    steps: [
  ...
  'Leverage Shrug': Exercise(
    name: 'Leverage Shrug',
    muscleGroup: 'Back',
    imageIds: ['Leverage_Shrug'],
    steps: [
  ...
  'Linear 3-Part Start Technique': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['Linear_3-Part_Start_Technique'],
    steps: [
  ...
  'Linear Acceleration Wall Drill': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['Linear_Acceleration_Wall_Drill'],
    steps: [
  ...
  'Low Cable Triceps Extension': Exercise(
    ...
    muscleGroup: 'Arms',
    imageIds: ['Low_Cable_Triceps_Extension'],
    steps: [
  ...
  'Low Pulley Row To Neck': Exercise(
    ...
    muscleGroup: 'Shoulders',
    imageIds: ['Low_Pulley_Row_To_Neck'],
    steps: [
  ...
  'Lower Back Curl': Exercise(
    name: 'Lower Back Curl',
    muscleGroup: 'Core',
    imageIds: ['Lower_Back_Curl'],
    steps: [
  ...
  'Lying Cambered Barbell Row': Exercise(
    name: 'Lying Cambered Barbell Row',
    muscleGroup: 'Back',
    imageIds: ['Lying_Cambered_Barbell_Row'],
    steps: [
  ...
  'Lying Close-Grip Bar Curl On High Pulley': Exercise(
    ...
    muscleGroup: 'Arms',
    imageIds: ['Lying_Close-Grip_Bar_Curl_On_High_Pulley'],
    steps: [
  ...
  'Lying Close-Grip Barbell Triceps Extension Behind The Head': Exercise(
    name: 'Lying Close-Grip Barbell Triceps Extension Behind The Head',
    muscleGroup: 'Arms',
    imageIds: ['Lying_Close-Grip_Barbell_Triceps_Extension_Behind_The_Head'],
    steps: [
  ...
  'Lying Close-Grip Barbell Triceps Press To Chin': Exercise(
    name: 'Lying Close-Grip Barbell Triceps Press To Chin',
    muscleGroup: 'Arms',
    imageIds: ['Lying_Close-Grip_Barbell_Triceps_Press_To_Chin'],
    steps: [
  ...
  'Lying Crossover': Exercise(
    name: 'Lying Crossover',
    muscleGroup: 'Legs',
    imageIds: ['Lying_Crossover'],
    steps: [
  ...
  'Lying Dumbbell Tricep Extension': Exercise(
    name: 'Lying Dumbbell Tricep Extension',
    muscleGroup: 'Arms',
    imageIds: ['Lying_Dumbbell_Tricep_Extension'],
    steps: [
  ...
  'Lying Face Down Plate Neck Resistance': Exercise(
    name: 'Lying Face Down Plate Neck Resistance',
    muscleGroup: 'Other',
    imageIds: ['Lying_Face_Down_Plate_Neck_Resistance'],
    steps: [
  ...
  'Lying Face Up Plate Neck Resistance': Exercise(
    ...
    muscleGroup: 'Other',
    imageIds: ['Lying_Face_Up_Plate_Neck_Resistance'],
    steps: [
  ...
  'Lying High Bench Barbell Curl': Exercise(
    name: 'Lying High Bench Barbell Curl',
    muscleGroup: 'Arms',
    imageIds: ['Lying_High_Bench_Barbell_Curl'],
    steps: [
  ...
  'Lying Machine Squat': Exercise(
    name: 'Lying Machine Squat',
    muscleGroup: 'Legs',
    imageIds: ['Lying_Machine_Squat'],
    steps: [
  ...
  'Lying One-Arm Lateral Raise': Exercise(
    name: 'Lying One-Arm Lateral Raise',
    muscleGroup: 'Shoulders',
    imageIds: ['Lying_One-Arm_Lateral_Raise'],
    steps: [
  ...
  'Lying Prone Quadriceps': Exercise(
    name: 'Lying Prone Quadriceps',
    muscleGroup: 'Legs',
    imageIds: ['Lying_Prone_Quadriceps'],
    steps: [
  ...
  'Lying Rear Delt Raise': Exercise(
    ...
    muscleGroup: 'Shoulders',
    imageIds: ['Lying_Rear_Delt_Raise'],
    steps: [
  ...
  'Lying Supine Dumbbell Curl': Exercise(
    ...
    muscleGroup: 'Arms',
    imageIds: ['Lying_Supine_Dumbbell_Curl'],
    steps: [
  ...
  'Lying T-Bar Row': Exercise(
    name: 'Lying T-Bar Row',
    muscleGroup: 'Back',
    imageIds: ['Lying_T-Bar_Row'],
    steps: [
  ...
  'Lying Triceps Press': Exercise(
    name: 'Lying Triceps Press',
    muscleGroup: 'Arms',
    imageIds: ['Lying_Triceps_Press'],
    steps: [
  ...
  'Machine Preacher Curls': Exercise(
    name: 'Machine Preacher Curls',
    muscleGroup: 'Arms',
    imageIds: ['Machine_Preacher_Curls'],
    steps: [
  ...
  'Machine Shoulder (Military) Press': Exercise(
    ...
    muscleGroup: 'Shoulders',
    imageIds: ['Machine_Shoulder_Military_Press'],
    steps: [
  ...
  'Machine Triceps Extension': Exercise(
    name: 'Machine Triceps Extension',
    muscleGroup: 'Arms',
    imageIds: ['Machine_Triceps_Extension'],
    steps: [
      'Adjust the seat to the appropriate height and make your weight selection. Place your upper arms against the pads and grasp the handles. This will be your starting position.',
  ...
  'Medicine Ball Chest Pass': Exercise(
    ...
    muscleGroup: 'Chest',
    imageIds: ['Medicine_Ball_Chest_Pass'],
    steps: [
  ...
  'Medicine Ball Full Twist': Exercise(
    ...
    muscleGroup: 'Core',
    imageIds: ['Medicine_Ball_Full_Twist'],
    steps: [
  ...
  'Medicine Ball Scoop Throw': Exercise(
    ...
    muscleGroup: 'Shoulders',
    imageIds: ['Medicine_Ball_Scoop_Throw'],
    steps: [
  ...
  'Moving Claw Series': Exercise(
    name: 'Moving Claw Series',
    muscleGroup: 'Legs',
    imageIds: ['Moving_Claw_Series'],
    steps: [
  ...
  'Muscle Snatch': Exercise(
    name: 'Muscle Snatch',
    muscleGroup: 'Legs',
    imageIds: ['Muscle_Snatch'],
    steps: [
  ...
  'Narrow Stance Hack Squats': Exercise(
    name: 'Narrow Stance Hack Squats',
    muscleGroup: 'Legs',
    imageIds: ['Narrow_Stance_Hack_Squats'],
    steps: [
      'Place the back of your torso against the back pad of the machine and hook your shoulders under the shoulder pads provided.',
  ...
  'Narrow Stance Leg Press': Exercise(
    name: 'Narrow Stance Leg Press',
    muscleGroup: 'Legs',
    imageIds: ['Narrow_Stance_Leg_Press'],
    steps: [
  ...
  'Narrow Stance Squats': Exercise(
    name: 'Narrow Stance Squats',
    muscleGroup: 'Legs',
    imageIds: ['Narrow_Stance_Squats'],
    steps: [
  ...
  'Natural Glute Ham Raise': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['Natural_Glute_Ham_Raise'],
    steps: [
  ...
  'Oblique Crunches - On The Floor': Exercise(
    ...
    muscleGroup: 'Core',
    imageIds: ['Oblique_Crunches_-_On_The_Floor'],
    steps: [
  ...
  'On-Your-Back Quad Stretch': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['On-Your-Back_Quad_Stretch'],
    steps: [
  ...
  'On Your Side Quad Stretch': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['On_Your_Side_Quad_Stretch'],
    steps: [
  ...
  'One-Arm Flat Bench Dumbbell Flye': Exercise(
    ...
    muscleGroup: 'Chest',
    imageIds: ['One-Arm_Flat_Bench_Dumbbell_Flye'],
    steps: [
  ...
  'One-Arm High-Pulley Cable Side Bends': Exercise(
    ...
    muscleGroup: 'Core',
    imageIds: ['One-Arm_High-Pulley_Cable_Side_Bends'],
    steps: [
  ...
  'One-Arm Incline Lateral Raise': Exercise(
    name: 'One-Arm Incline Lateral Raise',
    muscleGroup: 'Shoulders',
    imageIds: ['One-Arm_Incline_Lateral_Raise'],
    steps: [
  ...
  'One-Arm Kettlebell Clean': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['One-Arm_Kettlebell_Clean'],
    steps: [
  ...
  'One-Arm Kettlebell Clean and Jerk': Exercise(
    ...
    muscleGroup: 'Shoulders',
    imageIds: ['One-Arm_Kettlebell_Clean_and_Jerk'],
    steps: [
  ...
  'One-Arm Kettlebell Floor Press': Exercise(
    ...
    muscleGroup: 'Chest',
    imageIds: ['One-Arm_Kettlebell_Floor_Press'],
    steps: [
  ...
  'One-Arm Kettlebell Jerk': Exercise(
    name: 'One-Arm Kettlebell Jerk',
    muscleGroup: 'Shoulders',
    imageIds: ['One-Arm_Kettlebell_Jerk'],
    steps: [
  ...
  'One-Arm Kettlebell Military Press To The Side': Exercise(
    name: 'One-Arm Kettlebell Military Press To The Side',
    muscleGroup: 'Shoulders',
    imageIds: ['One-Arm_Kettlebell_Military_Press_To_The_Side'],
    steps: [
  ...
  'One-Arm Kettlebell Para Press': Exercise(
    ...
    muscleGroup: 'Shoulders',
    imageIds: ['One-Arm_Kettlebell_Para_Press'],
    steps: [
  ...
  'One-Arm Kettlebell Push Press': Exercise(
    name: 'One-Arm Kettlebell Push Press',
    muscleGroup: 'Shoulders',
    imageIds: ['One-Arm_Kettlebell_Push_Press'],
    steps: [
      'Hold a kettlebell by the handle. Clean the kettlebell to your shoulder by extending through the legs and hips as you pull the kettlebell towards your shoulder. Rotate your wrist as you do so, so that the palm faces forward. This will be your starting position.',
      'Dip your body by bending the knees, keeping your torso upright.',
  ...
  'One-Arm Kettlebell Row': Exercise(
    name: 'One-Arm Kettlebell Row',
    muscleGroup: 'Back',
    imageIds: ['One-Arm_Kettlebell_Row'],
    steps: [
  ...
  'One-Arm Kettlebell Snatch': Exercise(
    name: 'One-Arm Kettlebell Snatch',
    muscleGroup: 'Shoulders',
    imageIds: ['One-Arm_Kettlebell_Snatch'],
    steps: [
  ...
  'One-Arm Kettlebell Split Jerk': Exercise(
    name: 'One-Arm Kettlebell Split Jerk',
    muscleGroup: 'Shoulders',
    imageIds: ['One-Arm_Kettlebell_Split_Jerk'],
    steps: [
      'Hold a kettlebell by the handle. Clean the kettlebell to your shoulder by extending through the legs and hips as you pull the kettlebell towards your shoulder. Rotate your wrist as you do so, so that the palm faces forward. This will be your starting position.',
      'Dip your body by bending the knees, keeping your torso upright.',
      'Immediately reverse direction, driving through the heels, in essence jumping to create momentum. As you do so, press the kettlebell overhead to lockout by extending the arms, using your body\'s momentum to move the weight.',
  ...
  'One-Arm Kettlebell Split Snatch': Exercise(
    name: 'One-Arm Kettlebell Split Snatch',
    muscleGroup: 'Shoulders',
    imageIds: ['One-Arm_Kettlebell_Split_Snatch'],
    steps: [
  ...
  'One-Arm Kettlebell Swings': Exercise(
    name: 'One-Arm Kettlebell Swings',
    muscleGroup: 'Legs',
    imageIds: ['One-Arm_Kettlebell_Swings'],
    steps: [],
  ),
  'One-Arm Long Bar Row': Exercise(
    name: 'One-Arm Long Bar Row',
    muscleGroup: 'Back',
    imageIds: ['One-Arm_Long_Bar_Row'],
    steps: [
  ...
  'One-Arm Medicine Ball Slam': Exercise(
    ...
    muscleGroup: 'Core',
    imageIds: ['One-Arm_Medicine_Ball_Slam'],
    steps: [
  ...
  'One-Arm Open Palm Kettlebell Clean': Exercise(
    name: 'One-Arm Open Palm Kettlebell Clean',
    muscleGroup: 'Legs',
    imageIds: ['One-Arm_Open_Palm_Kettlebell_Clean'],
    steps: [
  ...
  'One-Arm Overhead Kettlebell Squats': Exercise(
    name: 'One-Arm Overhead Kettlebell Squats',
    muscleGroup: 'Legs',
    imageIds: ['One-Arm_Overhead_Kettlebell_Squats'],
    steps: [
  ...
  'One-Arm Side Deadlift': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['One-Arm_Side_Deadlift'],
    steps: [
  ...
  'One-Arm Side Laterals': Exercise(
    ...
    muscleGroup: 'Shoulders',
    imageIds: ['One-Arm_Side_Laterals'],
    steps: [
  ...
  'One-Legged Cable Kickback': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['One-Legged_Cable_Kickback'],
    steps: [
  ...
  'One Arm Dumbbell Bench Press': Exercise(
    ...
    muscleGroup: 'Chest',
    imageIds: ['One_Arm_Dumbbell_Bench_Press'],
    steps: [
  ...
  'One Arm Dumbbell Preacher Curl': Exercise(
    ...
    muscleGroup: 'Arms',
    imageIds: ['One_Arm_Dumbbell_Preacher_Curl'],
    steps: [
  ...
  'One Arm Floor Press': Exercise(
    name: 'One Arm Floor Press',
    muscleGroup: 'Arms',
    imageIds: ['One_Arm_Floor_Press'],
    steps: [
  ...
  'One Arm Pronated Dumbbell Triceps Extension': Exercise(
    ...
    muscleGroup: 'Arms',
    imageIds: ['One_Arm_Pronated_Dumbbell_Triceps_Extension'],
    steps: [
  ...
  'One Arm Supinated Dumbbell Triceps Extension': Exercise(
    ...
    muscleGroup: 'Arms',
    imageIds: ['One_Arm_Supinated_Dumbbell_Triceps_Extension'],
    steps: [
  ...
  'One Handed Hang': Exercise(
    name: 'One Handed Hang',
    muscleGroup: 'Back',
    imageIds: ['One_Handed_Hang'],
    steps: [
  ...
  'One Knee To Chest': Exercise(
    name: 'One Knee To Chest',
    muscleGroup: 'Legs',
    imageIds: ['One_Knee_To_Chest'],
    steps: [
  ...
  'One Leg Barbell Squat': Exercise(
    name: 'One Leg Barbell Squat',
    muscleGroup: 'Legs',
    imageIds: ['One_Leg_Barbell_Squat'],
    steps: [
  ...
  'Open Palm Kettlebell Clean': Exercise(
    name: 'Open Palm Kettlebell Clean',
    muscleGroup: 'Legs',
    imageIds: ['Open_Palm_Kettlebell_Clean'],
    steps: [
  ...
  'Pallof Press With Rotation': Exercise(
    ...
    muscleGroup: 'Core',
    imageIds: ['Pallof_Press_With_Rotation'],
    steps: [
  ...
  'Palms-Down Dumbbell Wrist Curl Over A Bench': Exercise(
    name: 'Palms-Down Dumbbell Wrist Curl Over A Bench',
    muscleGroup: 'Arms',
    imageIds: ['Palms-Down_Dumbbell_Wrist_Curl_Over_A_Bench'],
    steps: [
  ...
  'Palms-Down Wrist Curl Over A Bench': Exercise(
    name: 'Palms-Down Wrist Curl Over A Bench',
    muscleGroup: 'Arms',
    imageIds: ['Palms-Down_Wrist_Curl_Over_A_Bench'],
    steps: [
  ...
  'Palms-Up Barbell Wrist Curl Over A Bench': Exercise(
    name: 'Palms-Up Barbell Wrist Curl Over A Bench',
    muscleGroup: 'Arms',
    imageIds: ['Palms-Up_Barbell_Wrist_Curl_Over_A_Bench'],
    steps: [
      'Start out by placing a barbell on one side of a flat bench.',
      'Kneel down on both of your knees so that your body is facing the flat bench.',
  ...
  'Palms-Up Dumbbell Wrist Curl Over A Bench': Exercise(
    name: 'Palms-Up Dumbbell Wrist Curl Over A Bench',
    muscleGroup: 'Arms',
    imageIds: ['Palms-Up_Dumbbell_Wrist_Curl_Over_A_Bench'],
    steps: [
      'Start out by placing two dumbbells on one side of a flat bench.',
      'Kneel down on both of your knees so that your body is facing the flat bench.',
  ...
  'Parallel Bar Dip': Exercise(
    name: 'Parallel Bar Dip',
    muscleGroup: 'Arms',
    imageIds: ['Parallel_Bar_Dip'],
    steps: [
  ...
  'Pelvic Tilt Into Bridge': Exercise(
    ...
    muscleGroup: 'Back',
    imageIds: ['Pelvic_Tilt_Into_Bridge'],
    steps: [
  ...
  'Physioball Hip Bridge': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['Physioball_Hip_Bridge'],
    steps: [
  ...
  'Pin Presses': Exercise(
    name: 'Pin Presses',
    muscleGroup: 'Arms',
    imageIds: ['Pin_Presses'],
    steps: [
  ...
  'Piriformis-SMR': Exercise(
    name: 'Piriformis-SMR',
    muscleGroup: 'Legs',
    imageIds: ['Piriformis-SMR'],
    steps: [
  ...
  'Platform Hamstring Slides': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['Platform_Hamstring_Slides'],
    steps: [
  ...
  'Plie Dumbbell Squat': Exercise(
    name: 'Plie Dumbbell Squat',
    muscleGroup: 'Legs',
    imageIds: ['Plie_Dumbbell_Squat'],
    steps: [
  ...
  'Plyo Kettlebell Pushups': Exercise(
    ...
    muscleGroup: 'Chest',
    imageIds: ['Plyo_Kettlebell_Pushups'],
    steps: [
  ...
  'Plyo Push-up': Exercise(
    name: 'Plyo Push-up',
    muscleGroup: 'Chest',
    imageIds: ['Plyo_Push-up'],
    steps: [
      'Move into a prone position on the floor, supporting your weight on your hands and toes.',
      'Your arms should be fully extended with the hands around shoulder width. Keep your body straight throughout the movement. This will be your starting position.',
  ...
  'Posterior Tibialis Stretch': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['Posterior_Tibialis_Stretch'],
    steps: [
      'In a seated position, loop a belt, rope, or band around one foot. This will be your starting position.',
  ...
  'Power Clean from Blocks': Exercise(
    name: 'Power Clean from Blocks',
    muscleGroup: 'Legs',
    imageIds: ['Power_Clean_from_Blocks'],
    steps: [
  ...
  'Power Partials': Exercise(
    name: 'Power Partials',
    muscleGroup: 'Shoulders',
    imageIds: ['Power_Partials'],
    steps: [
      'Stand up with your torso upright and a dumbbell on each hand being held at arms length. The elbows should be close to the torso.',
  ...
  'Power Snatch from Blocks': Exercise(
    name: 'Power Snatch from Blocks',
    muscleGroup: 'Legs',
    imageIds: ['Power_Snatch_from_Blocks'],
    steps: [
  ...
  'Power Stairs': Exercise(
    name: 'Power Stairs',
    muscleGroup: 'Legs',
    imageIds: ['Power_Stairs'],
    steps: [
  ...
  'Preacher Hammer Dumbbell Curl': Exercise(
    name: 'Preacher Hammer Dumbbell Curl',
    muscleGroup: 'Arms',
    imageIds: ['Preacher_Hammer_Dumbbell_Curl'],
    steps: [
  ...
  'Prone Manual Hamstring': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['Prone_Manual_Hamstring'],
    steps: [
  ...
  'Push-Up Wide': Exercise(
    name: 'Push-Up Wide',
    muscleGroup: 'Chest',
    imageIds: ['Push-Up_Wide'],
    steps: [
  ...
  'Push-Ups - Close Triceps Position': Exercise(
    name: 'Push-Ups - Close Triceps Position',
    muscleGroup: 'Arms',
    imageIds: ['Push-Ups_-_Close_Triceps_Position'],
    steps: [
  ...
  'Push-Ups With Feet Elevated': Exercise(
    name: 'Push-Ups With Feet Elevated',
    muscleGroup: 'Chest',
    imageIds: ['Push-Ups_With_Feet_Elevated'],
    steps: [
  ...
  'Push-Ups With Feet On An Exercise Ball': Exercise(
    name: 'Push-Ups With Feet On An Exercise Ball',
    muscleGroup: 'Chest',
    imageIds: ['Push-Ups_With_Feet_On_An_Exercise_Ball'],
    steps: [
      'Lie on the floor face down and place your hands about 36 inches apart from each other holding your torso up at arms length.',
  ...
  'Push Press - Behind the Neck': Exercise(
    name: 'Push Press - Behind the Neck',
    muscleGroup: 'Shoulders',
    imageIds: ['Push_Press_-_Behind_the_Neck'],
    steps: [
  ...
  'Push Up to Side Plank': Exercise(
    ...
    muscleGroup: 'Chest',
    imageIds: ['Push_Up_to_Side_Plank'],
    steps: [
  ...
  'Pushups (Close and Wide Hand Positions)': Exercise(
    name: 'Pushups (Close and Wide Hand Positions)',
    muscleGroup: 'Chest',
    imageIds: ['Pushups_Close_and_Wide_Hand_Positions'],
    steps: [
  ...
  'Quadriceps-SMR': Exercise(
    name: 'Quadriceps-SMR',
    muscleGroup: 'Legs',
    imageIds: ['Quadriceps-SMR'],
    steps: [
  ...
  'Rack Pull with Bands': Exercise(
    name: 'Rack Pull with Bands',
    muscleGroup: 'Back',
    imageIds: ['Rack_Pull_with_Bands'],
    steps: [
  ...
  'Rear Leg Raises': Exercise(
    name: 'Rear Leg Raises',
    muscleGroup: 'Legs',
    imageIds: ['Rear_Leg_Raises'],
    steps: [
  ...
  'Return Push from Stance': Exercise(
    ...
    muscleGroup: 'Shoulders',
    imageIds: ['Return_Push_from_Stance'],
    steps: [
  ...
  'Reverse Band Bench Press': Exercise(
    name: 'Reverse Band Bench Press',
    muscleGroup: 'Arms',
    imageIds: ['Reverse_Band_Bench_Press'],
    steps: [
  ...
  'Reverse Band Box Squat': Exercise(
    name: 'Reverse Band Box Squat',
    muscleGroup: 'Legs',
    imageIds: ['Reverse_Band_Box_Squat'],
    steps: [
  ...
  'Reverse Band Deadlift': Exercise(
    name: 'Reverse Band Deadlift',
    muscleGroup: 'Back',
    imageIds: ['Reverse_Band_Deadlift'],
    steps: [
  ...
  'Reverse Band Power Squat': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['Reverse_Band_Power_Squat'],
    steps: [
  ...
  'Reverse Band Sumo Deadlift': Exercise(
    name: 'Reverse Band Sumo Deadlift',
    muscleGroup: 'Legs',
    imageIds: ['Reverse_Band_Sumo_Deadlift'],
    steps: [
  ...
  'Reverse Barbell Curl': Exercise(
    name: 'Reverse Barbell Curl',
    muscleGroup: 'Arms',
    imageIds: ['Reverse_Barbell_Curl'],
    steps: [
  ...
  'Reverse Barbell Preacher Curls': Exercise(
    ...
    muscleGroup: 'Arms',
    imageIds: ['Reverse_Barbell_Preacher_Curls'],
    steps: [
  ...
  'Reverse Flyes With External Rotation': Exercise(
    ...
    muscleGroup: 'Shoulders',
    imageIds: ['Reverse_Flyes_With_External_Rotation'],
    steps: [
  ...
  'Reverse Grip Bent-Over Rows': Exercise(
    ...
    muscleGroup: 'Back',
    imageIds: ['Reverse_Grip_Bent-Over_Rows'],
    steps: [
  ...
  'Reverse Grip Triceps Pushdown': Exercise(
    name: 'Reverse Grip Triceps Pushdown',
    muscleGroup: 'Arms',
    imageIds: ['Reverse_Grip_Triceps_Pushdown'],
    steps: [
  ...
  'Reverse Hyperextension': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['Reverse_Hyperextension'],
    steps: [
  ...
  'Reverse Machine Flyes': Exercise(
    ...
    muscleGroup: 'Shoulders',
    imageIds: ['Reverse_Machine_Flyes'],
    steps: [
  ...
  'Reverse Plate Curls': Exercise(
    name: 'Reverse Plate Curls',
    muscleGroup: 'Arms',
    imageIds: ['Reverse_Plate_Curls'],
    steps: [
  ...
  'Reverse Triceps Bench Press': Exercise(
    name: 'Reverse Triceps Bench Press',
    muscleGroup: 'Arms',
    imageIds: ['Reverse_Triceps_Bench_Press'],
    steps: [
  ...
  'Rhomboids-SMR': Exercise(
    name: 'Rhomboids-SMR',
    muscleGroup: 'Back',
    imageIds: ['Rhomboids-SMR'],
    steps: [
  ...
  'Rocking Standing Calf Raise': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['Rocking_Standing_Calf_Raise'],
    steps: [
  ...
  'Rocky Pull-Ups/Pulldowns': Exercise(
    ...
    muscleGroup: 'Back',
    imageIds: ['Rocky_Pull-Ups_Pulldowns'],
    steps: [
  ...
  'Romanian Deadlift from Deficit': Exercise(
    name: 'Romanian Deadlift from Deficit',
    muscleGroup: 'Legs',
    imageIds: ['Romanian_Deadlift_from_Deficit'],
    steps: [
  ...
  'Rope Straight-Arm Pulldown': Exercise(
    name: 'Rope Straight-Arm Pulldown',
    muscleGroup: 'Back',
    imageIds: ['Rope_Straight-Arm_Pulldown'],
    steps: [
  ...
  'Round The World Shoulder Stretch': Exercise(
    ...
    muscleGroup: 'Shoulders',
    imageIds: ['Round_The_World_Shoulder_Stretch'],
    steps: [
  ...
  'Rowing, Stationary': Exercise(
    name: 'Rowing, Stationary',
    muscleGroup: 'Legs',
    imageIds: ['Rowing_Stationary'],
    steps: [
  ...
  'Sandbag Load': Exercise(
    name: 'Sandbag Load',
    muscleGroup: 'Legs',
    imageIds: ['Sandbag_Load'],
    steps: [
  ...
  'Scissors Jump': Exercise(
    name: 'Scissors Jump',
    muscleGroup: 'Legs',
    imageIds: ['Scissors_Jump'],
    steps: [
  ...
  'Seated Band Hamstring Curl': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['Seated_Band_Hamstring_Curl'],
    steps: [
  ...
  'Seated Barbell Military Press': Exercise(
    name: 'Seated Barbell Military Press',
    muscleGroup: 'Shoulders',
    imageIds: ['Seated_Barbell_Military_Press'],
    steps: [
  ...
  'Seated Barbell Twist': Exercise(
    name: 'Seated Barbell Twist',
    muscleGroup: 'Core',
    imageIds: ['Seated_Barbell_Twist'],
    steps: [
  ...
  'Seated Bent-Over One-Arm Dumbbell Triceps Extension': Exercise(
    ...
    muscleGroup: 'Arms',
    imageIds: ['Seated_Bent-Over_One-Arm_Dumbbell_Triceps_Extension'],
    steps: [
  ...
  'Seated Bent-Over Rear Delt Raise': Exercise(
    ...
    muscleGroup: 'Shoulders',
    imageIds: ['Seated_Bent-Over_Rear_Delt_Raise'],
    steps: [
  ...
  'Seated Bent-Over Two-Arm Dumbbell Triceps Extension': Exercise(
    ...
    muscleGroup: 'Arms',
    imageIds: ['Seated_Bent-Over_Two-Arm_Dumbbell_Triceps_Extension'],
    steps: [
  ...
  'Seated Cable Shoulder Press': Exercise(
    ...
    muscleGroup: 'Shoulders',
    imageIds: ['Seated_Cable_Shoulder_Press'],
    steps: [
  ...
  'Seated Close-Grip Concentration Barbell Curl': Exercise(
    ...
    muscleGroup: 'Arms',
    imageIds: ['Seated_Close-Grip_Concentration_Barbell_Curl'],
    steps: [
  ...
  'Seated Dumbbell Inner Biceps Curl': Exercise(
    name: 'Seated Dumbbell Inner Biceps Curl',
    muscleGroup: 'Arms',
    imageIds: ['Seated_Dumbbell_Inner_Biceps_Curl'],
    steps: [
  ...
  'Seated Dumbbell Palms-Down Wrist Curl': Exercise(
    ...
    muscleGroup: 'Arms',
    imageIds: ['Seated_Dumbbell_Palms-Down_Wrist_Curl'],
    steps: [
  ...
  'Seated Dumbbell Palms-Up Wrist Curl': Exercise(
    name: 'Seated Dumbbell Palms-Up Wrist Curl',
    muscleGroup: 'Arms',
    imageIds: ['Seated_Dumbbell_Palms-Up_Wrist_Curl'],
    steps: [
      'Start out by placing two dumbbells on the floor in front of a flat bench.',
      'Sit down on the edge of the flat bench with your legs at about shoulder width apart. Make sure to keep your feet on the floor.',
  ...
  'Seated Dumbbell Press': Exercise(
    ...
    muscleGroup: 'Shoulders',
    imageIds: ['Seated_Dumbbell_Press'],
    steps: [
  ...
  'Seated Flat Bench Leg Pull-In': Exercise(
    ...
    muscleGroup: 'Core',
    imageIds: ['Seated_Flat_Bench_Leg_Pull-In'],
    steps: [
  ...
  'Seated Floor Hamstring Stretch': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['Seated_Floor_Hamstring_Stretch'],
    steps: [
  ...
  'Seated Hamstring and Calf Stretch': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['Seated_Hamstring_and_Calf_Stretch'],
    steps: [
  ...
  'Seated Head Harness Neck Resistance': Exercise(
    ...
    muscleGroup: 'Other',
    imageIds: ['Seated_Head_Harness_Neck_Resistance'],
    steps: [
  ...
  'Seated One-Arm Dumbbell Palms-Down Wrist Curl': Exercise(
    name: 'Seated One-Arm Dumbbell Palms-Down Wrist Curl',
    muscleGroup: 'Arms',
    imageIds: ['Seated_One-Arm_Dumbbell_Palms-Down_Wrist_Curl'],
    steps: [
  ...
  'Seated One-Arm Dumbbell Palms-Up Wrist Curl': Exercise(
    ...
    muscleGroup: 'Arms',
    imageIds: ['Seated_One-Arm_Dumbbell_Palms-Up_Wrist_Curl'],
    steps: [
      'Sit on a flat bench with a dumbbell in your right hand.',
      'Place your feet flat on the floor, at a distance that is slightly wider than shoulder width apart.',
  ...
  'Seated One-arm Cable Pulley Rows': Exercise(
    ...
    muscleGroup: 'Back',
    imageIds: ['Seated_One-arm_Cable_Pulley_Rows'],
    steps: [
  ...
  'Seated Overhead Stretch': Exercise(
    ...
    muscleGroup: 'Core',
    imageIds: ['Seated_Overhead_Stretch'],
    steps: [
      'Sit up straight on an exercise mat.',
  ...
  'Seated Palm-Up Barbell Wrist Curl': Exercise(
    ...
    muscleGroup: 'Arms',
    imageIds: ['Seated_Palm-Up_Barbell_Wrist_Curl'],
    steps: [
      'Hold a barbell with both hands and your palms facing up; hands spaced about shoulder width.',
      'Place your feet flat on the floor, at a distance that is slightly wider than shoulder width apart.',
  ...
  'Seated Palms-Down Barbell Wrist Curl': Exercise(
    ...
    muscleGroup: 'Arms',
    imageIds: ['Seated_Palms-Down_Barbell_Wrist_Curl'],
    steps: [
  ...
  'Seated Side Lateral Raise': Exercise(
    name: 'Seated Side Lateral Raise',
    muscleGroup: 'Shoulders',
    imageIds: ['Seated_Side_Lateral_Raise'],
    steps: [
  ...
  'Seated Two-Arm Palms-Up Low-Pulley Wrist Curl': Exercise(
    ...
    muscleGroup: 'Arms',
    imageIds: ['Seated_Two-Arm_Palms-Up_Low-Pulley_Wrist_Curl'],
    steps: [
  ...
  'See-Saw Press (Alternating Side Press)': Exercise(
    ...
    muscleGroup: 'Shoulders',
    imageIds: ['See-Saw_Press_Alternating_Side_Press'],
    steps: [
  ...
  'Shoulder Press - With Bands': Exercise(
    name: 'Shoulder Press - With Bands',
    muscleGroup: 'Shoulders',
    imageIds: ['Shoulder_Press_-_With_Bands'],
    steps: [
  ...
  'Side-Lying Floor Stretch': Exercise(
    ...
    muscleGroup: 'Back',
    imageIds: ['Side-Lying_Floor_Stretch'],
    steps: [
  ...
  'Side Bridge': Exercise(
    name: 'Side Bridge',
    muscleGroup: 'Core',
    imageIds: ['Side_Bridge'],
    steps: [],
  ),
  'Side Hop-Sprint': Exercise(
    name: 'Side Hop-Sprint',
    muscleGroup: 'Legs',
    imageIds: ['Side_Hop-Sprint'],
    steps: [
  ...
  'Side Laterals to Front Raise': Exercise(
    ...
    muscleGroup: 'Shoulders',
    imageIds: ['Side_Laterals_to_Front_Raise'],
    steps: [
  ...
  'Side Lying Groin Stretch': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['Side_Lying_Groin_Stretch'],
    steps: [
  ...
  'Side Standing Long Jump': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['Side_Standing_Long_Jump'],
    steps: [
  ...
  'Side To Side Chins': Exercise(
    name: 'Side To Side Chins',
    muscleGroup: 'Back',
    imageIds: ['Side_To_Side_Chins'],
    steps: [
      'Grab the pull-up bar with the palms facing forward using a wide grip.',
  ...
  'Side Wrist Pull': Exercise(
    name: 'Side Wrist Pull',
    muscleGroup: 'Shoulders',
    imageIds: ['Side_Wrist_Pull'],
    steps: [
  ...
  'Side to Side Box Shuffle': Exercise(
    name: 'Side to Side Box Shuffle',
    muscleGroup: 'Legs',
    imageIds: ['Side_to_Side_Box_Shuffle'],
    steps: [
  ...
  'Single-Arm Cable Crossover': Exercise(
    ...
    muscleGroup: 'Chest',
    imageIds: ['Single-Arm_Cable_Crossover'],
    steps: [
      'Begin by moving the pulleys to the high position, select the resistance to be used, and take a handle in each hand.',
  ...
  'Single-Arm Linear Jammer': Exercise(
    ...
    muscleGroup: 'Shoulders',
    imageIds: ['Single-Arm_Linear_Jammer'],
    steps: [
      'Position a bar into a landmine or securely anchor it in a corner. Load the bar to an appropriate weight.',
  ...
  'Single-Cone Sprint Drill': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['Single-Cone_Sprint_Drill'],
    steps: [
  ...
  'Single-Leg High Box Squat': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['Single-Leg_High_Box_Squat'],
    steps: [
  ...
  'Single-Leg Hop Progression': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['Single-Leg_Hop_Progression'],
    steps: [
  ...
  'Single-Leg Lateral Hop': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['Single-Leg_Lateral_Hop'],
    steps: [
  ...
  'Single-Leg Leg Extension': Exercise(
    name: 'Single-Leg Leg Extension',
    muscleGroup: 'Legs',
    imageIds: ['Single-Leg_Leg_Extension'],
    steps: [
  ...
  'Single-Leg Stride Jump': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['Single-Leg_Stride_Jump'],
    steps: [
  ...
  'Single Dumbbell Raise': Exercise(
    name: 'Single Dumbbell Raise',
    muscleGroup: 'Shoulders',
    imageIds: ['Single_Dumbbell_Raise'],
    steps: [
  ...
  'Single Leg Butt Kick': Exercise(
    name: 'Single Leg Butt Kick',
    muscleGroup: 'Legs',
    imageIds: ['Single_Leg_Butt_Kick'],
    steps: [
  ...
  'Single Leg Glute Bridge': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['Single_Leg_Glute_Bridge'],
    steps: [
  ...
  'Sled Drag - Harness': Exercise(
    name: 'Sled Drag - Harness',
    muscleGroup: 'Legs',
    imageIds: ['Sled_Drag_-_Harness'],
    steps: [
  ...
  'Sled Overhead Backward Walk': Exercise(
    ...
    muscleGroup: 'Shoulders',
    imageIds: ['Sled_Overhead_Backward_Walk'],
    steps: [
  ...
  'Sled Overhead Triceps Extension': Exercise(
    ...
    muscleGroup: 'Arms',
    imageIds: ['Sled_Overhead_Triceps_Extension'],
    steps: [
  ...
  'Smith Incline Shoulder Raise': Exercise(
    ...
    muscleGroup: 'Shoulders',
    imageIds: ['Smith_Incline_Shoulder_Raise'],
    steps: [
  ...
  'Smith Machine Behind the Back Shrug': Exercise(
    ...
    muscleGroup: 'Back',
    imageIds: ['Smith_Machine_Behind_the_Back_Shrug'],
    steps: [
  ...
  'Smith Machine Bench Press': Exercise(
    name: 'Smith Machine Bench Press',
    muscleGroup: 'Chest',
    imageIds: ['Smith_Machine_Bench_Press'],
    steps: [
  ...
  'Smith Machine Bent Over Row': Exercise(
    ...
    muscleGroup: 'Back',
    imageIds: ['Smith_Machine_Bent_Over_Row'],
    steps: [
  ...
  'Smith Machine Calf Raise': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['Smith_Machine_Calf_Raise'],
    steps: [
  ...
  'Smith Machine Close-Grip Bench Press': Exercise(
    name: 'Smith Machine Close-Grip Bench Press',
    muscleGroup: 'Arms',
    imageIds: ['Smith_Machine_Close-Grip_Bench_Press'],
    steps: [
  ...
  'Smith Machine Decline Press': Exercise(
    name: 'Smith Machine Decline Press',
    muscleGroup: 'Chest',
    imageIds: ['Smith_Machine_Decline_Press'],
    steps: [
  ...
  'Smith Machine Hang Power Clean': Exercise(
    name: 'Smith Machine Hang Power Clean',
    muscleGroup: 'Legs',
    imageIds: ['Smith_Machine_Hang_Power_Clean'],
    steps: [
  ...
  'Smith Machine Hip Raise': Exercise(
    ...
    muscleGroup: 'Core',
    imageIds: ['Smith_Machine_Hip_Raise'],
    steps: [
  ...
  'Smith Machine Incline Bench Press': Exercise(
    name: 'Smith Machine Incline Bench Press',
    muscleGroup: 'Chest',
    imageIds: ['Smith_Machine_Incline_Bench_Press'],
    steps: [
  ...
  'Smith Machine Leg Press': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['Smith_Machine_Leg_Press'],
    steps: [
  ...
  'Smith Machine One-Arm Upright Row': Exercise(
    name: 'Smith Machine One-Arm Upright Row',
    muscleGroup: 'Shoulders',
    imageIds: ['Smith_Machine_One-Arm_Upright_Row'],
    steps: [
      'With the bar at thigh level, load an appropriate weight.',
  ...
  'Smith Machine Overhead Shoulder Press': Exercise(
    ...
    muscleGroup: 'Shoulders',
    imageIds: ['Smith_Machine_Overhead_Shoulder_Press'],
    steps: [
  ...
  'Smith Machine Pistol Squat': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['Smith_Machine_Pistol_Squat'],
    steps: [
  ...
  'Smith Machine Reverse Calf Raises': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['Smith_Machine_Reverse_Calf_Raises'],
    steps: [
  ...
  'Smith Machine Stiff-Legged Deadlift': Exercise(
    name: 'Smith Machine Stiff-Legged Deadlift',
    muscleGroup: 'Legs',
    imageIds: ['Smith_Machine_Stiff-Legged_Deadlift'],
    steps: [
  ...
  'Smith Machine Upright Row': Exercise(
    ...
    muscleGroup: 'Back',
    imageIds: ['Smith_Machine_Upright_Row'],
    steps: [
      'To begin, set the bar on the smith machine to a height that is around the middle of your thighs. Once the correct height is chosen and the bar is loaded, grasp the bar using a pronated (palms forward) grip that is shoulder width apart. You may need some wrist wraps if using a significant amount of weight.',
  ...
  'Smith Single-Leg Split Squat': Exercise(
    name: 'Smith Single-Leg Split Squat',
    muscleGroup: 'Legs',
    imageIds: ['Smith_Single-Leg_Split_Squat'],
    steps: [
  ...
  'Snatch Pull': Exercise(
    name: 'Snatch Pull',
    muscleGroup: 'Legs',
    imageIds: ['Snatch_Pull'],
    steps: [
  ...
  'Snatch Shrug': Exercise(
    name: 'Snatch Shrug',
    muscleGroup: 'Back',
    imageIds: ['Snatch_Shrug'],
    steps: [
  ...
  'Speed Band Overhead Triceps': Exercise(
    ...
    muscleGroup: 'Arms',
    imageIds: ['Speed_Band_Overhead_Triceps'],
    steps: [
  ...
  'Speed Squats': Exercise(
    name: 'Speed Squats',
    muscleGroup: 'Legs',
    imageIds: ['Speed_Squats'],
    steps: [
      'This exercise is best performed inside a squat rack for safety purposes. To begin, first set the bar on a rack that best matches your height. Once the correct height is chosen and the bar is loaded, step under the bar and place the back of your shoulders (slightly below the neck) across it.',
      'Hold on to the bar using both arms at each side and lift it off the rack by first pushing with your legs and at the same time straightening your torso.',
  ...
  'Split Clean': Exercise(
    name: 'Split Clean',
    muscleGroup: 'Legs',
    imageIds: ['Split_Clean'],
    steps: [
  ...
  'Split Squat with Dumbbells': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['Split_Squat_with_Dumbbells'],
    steps: [
  ...
  'Squat with Bands': Exercise(
    name: 'Squat with Bands',
    muscleGroup: 'Legs',
    imageIds: ['Squat_with_Bands'],
    steps: [
  ...
  'Squat with Chains': Exercise(
    name: 'Squat with Chains',
    muscleGroup: 'Legs',
    imageIds: ['Squat_with_Chains'],
    steps: [
      'To set up the chains, begin by looping the leader chain over the sleeves of the bar. The heavy chain should be attached using a snap hook. Adjust the length of the lead chain so that a few links are still on the floor at the top of the movement.',
      'Begin by stepping under the bar and placing it across the back of the shoulders. Squeeze your shoulder blades together and rotate your elbows forward, attempting to bend the bar across your shoulders. Remove the bar from the rack, creating a tight arch in your lower back, and step back into position. Place your feet wide for more emphasis on the back, glutes, adductors, and hamstrings. Keep your head facing forward.',
      'With your back, shoulders, and core tight, push your knees and butt out and you begin your descent. Sit back with your hips as much as possible. Ideally, your shins should be perpendicular to the ground. Lower bar position necessitates a greater torso lean to keep the bar over the heels. Continue until you break parallel, which is defined as the crease of the hip being in line with the top of the knee.',
  ...
  'Squat with Plate Movers': Exercise(
    name: 'Squat with Plate Movers',
    muscleGroup: 'Legs',
    imageIds: ['Squat_with_Plate_Movers'],
    steps: [
  ...
  'Squats - With Bands': Exercise(
    name: 'Squats - With Bands',
    muscleGroup: 'Legs',
    imageIds: ['Squats_-_With_Bands'],
    steps: [
  ...
  'Standing Alternating Dumbbell Press': Exercise(
    name: 'Standing Alternating Dumbbell Press',
    muscleGroup: 'Shoulders',
    imageIds: ['Standing_Alternating_Dumbbell_Press'],
    steps: [
  ...
  'Standing Barbell Calf Raise': Exercise(
    name: 'Standing Barbell Calf Raise',
    muscleGroup: 'Legs',
    imageIds: ['Standing_Barbell_Calf_Raise'],
    steps: [
  ...
  'Standing Barbell Press Behind Neck': Exercise(
    name: 'Standing Barbell Press Behind Neck',
    muscleGroup: 'Shoulders',
    imageIds: ['Standing_Barbell_Press_Behind_Neck'],
    steps: [
  ...
  'Standing Bent-Over One-Arm Dumbbell Triceps Extension': Exercise(
    ...
    muscleGroup: 'Arms',
    imageIds: ['Standing_Bent-Over_One-Arm_Dumbbell_Triceps_Extension'],
    steps: [
  ...
  'Standing Bent-Over Two-Arm Dumbbell Triceps Extension': Exercise(
    name: 'Standing Bent-Over Two-Arm Dumbbell Triceps Extension',
    muscleGroup: 'Arms',
    imageIds: ['Standing_Bent-Over_Two-Arm_Dumbbell_Triceps_Extension'],
    steps: [
  ...
  'Standing Biceps Cable Curl': Exercise(
    name: 'Standing Biceps Cable Curl',
    muscleGroup: 'Arms',
    imageIds: ['Standing_Biceps_Cable_Curl'],
    steps: [
  ...
  'Standing Biceps Stretch': Exercise(
    ...
    muscleGroup: 'Arms',
    imageIds: ['Standing_Biceps_Stretch'],
    steps: [
  ...
  'Standing Bradford Press': Exercise(
    ...
    muscleGroup: 'Shoulders',
    imageIds: ['Standing_Bradford_Press'],
    steps: [
  ...
  'Standing Cable Chest Press': Exercise(
    ...
    muscleGroup: 'Chest',
    imageIds: ['Standing_Cable_Chest_Press'],
    steps: [
  ...
  'Standing Cable Wood Chop': Exercise(
    ...
    muscleGroup: 'Core',
    imageIds: ['Standing_Cable_Wood_Chop'],
    steps: [
  ...
  'Standing Concentration Curl': Exercise(
    name: 'Standing Concentration Curl',
    muscleGroup: 'Arms',
    imageIds: ['Standing_Concentration_Curl'],
    steps: [
  ...
  'Standing Dumbbell Calf Raise': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['Standing_Dumbbell_Calf_Raise'],
    steps: [
  ...
  'Standing Dumbbell Press': Exercise(
    ...
    muscleGroup: 'Shoulders',
    imageIds: ['Standing_Dumbbell_Press'],
    steps: [
  ...
  'Standing Dumbbell Reverse Curl': Exercise(
    name: 'Standing Dumbbell Reverse Curl',
    muscleGroup: 'Arms',
    imageIds: ['Standing_Dumbbell_Reverse_Curl'],
    steps: [
  ...
  'Standing Dumbbell Straight-Arm Front Delt Raise Above Head': Exercise(
    ...
    muscleGroup: 'Shoulders',
    imageIds: ['Standing_Dumbbell_Straight-Arm_Front_Delt_Raise_Above_Head'],
    steps: [
  ...
  'Standing Dumbbell Triceps Extension': Exercise(
    ...
    muscleGroup: 'Arms',
    imageIds: ['Standing_Dumbbell_Triceps_Extension'],
    steps: [
  ...
  'Standing Dumbbell Upright Row': Exercise(
    name: 'Standing Dumbbell Upright Row',
    muscleGroup: 'Back',
    imageIds: ['Standing_Dumbbell_Upright_Row'],
    steps: [
  ...
  'Standing Elevated Quad Stretch': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['Standing_Elevated_Quad_Stretch'],
    steps: [
  ...
  'Standing Front Barbell Raise Over Head': Exercise(
    ...
    muscleGroup: 'Shoulders',
    imageIds: ['Standing_Front_Barbell_Raise_Over_Head'],
    steps: [
  ...
  'Standing Gastrocnemius Calf Stretch': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['Standing_Gastrocnemius_Calf_Stretch'],
    steps: [
  ...
  'Standing Hamstring and Calf Stretch': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['Standing_Hamstring_and_Calf_Stretch'],
    steps: [
  ...
  'Standing Hip Flexors': Exercise(
    name: 'Standing Hip Flexors',
    muscleGroup: 'Legs',
    imageIds: ['Standing_Hip_Flexors'],
    steps: [
  ...
  'Standing Inner-Biceps Curl': Exercise(
    name: 'Standing Inner-Biceps Curl',
    muscleGroup: 'Arms',
    imageIds: ['Standing_Inner-Biceps_Curl'],
    steps: [
  ...
  'Standing Lateral Stretch': Exercise(
    ...
    muscleGroup: 'Core',
    imageIds: ['Standing_Lateral_Stretch'],
    steps: [
  ...
  'Standing Low-Pulley Deltoid Raise': Exercise(
    ...
    muscleGroup: 'Shoulders',
    imageIds: ['Standing_Low-Pulley_Deltoid_Raise'],
    steps: [
  ...
  'Standing Low-Pulley One-Arm Triceps Extension': Exercise(
    ...
    muscleGroup: 'Arms',
    imageIds: ['Standing_Low-Pulley_One-Arm_Triceps_Extension'],
    steps: [
  ...
  'Standing Military Press': Exercise(
    ...
    muscleGroup: 'Shoulders',
    imageIds: ['Standing_Military_Press'],
    steps: [
  ...
  'Standing Olympic Plate Hand Squeeze': Exercise(
    name: 'Standing Olympic Plate Hand Squeeze',
    muscleGroup: 'Arms',
    imageIds: ['Standing_Olympic_Plate_Hand_Squeeze'],
    steps: [
  ...
  'Standing One-Arm Cable Curl': Exercise(
    ...
    muscleGroup: 'Arms',
    imageIds: ['Standing_One-Arm_Cable_Curl'],
    steps: [
  ...
  'Standing One-Arm Dumbbell Curl Over Incline Bench': Exercise(
    ...
    muscleGroup: 'Arms',
    imageIds: ['Standing_One-Arm_Dumbbell_Curl_Over_Incline_Bench'],
    steps: [
  ...
  'Standing One-Arm Dumbbell Triceps Extension': Exercise(
    name: 'Standing One-Arm Dumbbell Triceps Extension',
    muscleGroup: 'Arms',
    imageIds: ['Standing_One-Arm_Dumbbell_Triceps_Extension'],
    steps: [
  ...
  'Standing Overhead Barbell Triceps Extension': Exercise(
    name: 'Standing Overhead Barbell Triceps Extension',
    muscleGroup: 'Arms',
    imageIds: ['Standing_Overhead_Barbell_Triceps_Extension'],
    steps: [
  ...
  'Standing Palm-In One-Arm Dumbbell Press': Exercise(
    name: 'Standing Palm-In One-Arm Dumbbell Press',
    muscleGroup: 'Shoulders',
    imageIds: ['Standing_Palm-In_One-Arm_Dumbbell_Press'],
    steps: [
  ...
  'Standing Palms-In Dumbbell Press': Exercise(
    name: 'Standing Palms-In Dumbbell Press',
    muscleGroup: 'Shoulders',
    imageIds: ['Standing_Palms-In_Dumbbell_Press'],
    steps: [
  ...
  'Standing Palms-Up Barbell Behind The Back Wrist Curl': Exercise(
    name: 'Standing Palms-Up Barbell Behind The Back Wrist Curl',
    muscleGroup: 'Arms',
    imageIds: ['Standing_Palms-Up_Barbell_Behind_The_Back_Wrist_Curl'],
    steps: [
  ...
  'Standing Soleus And Achilles Stretch': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['Standing_Soleus_And_Achilles_Stretch'],
    steps: [
  ...
  'Standing Toe Touches': Exercise(
    name: 'Standing Toe Touches',
    muscleGroup: 'Legs',
    imageIds: ['Standing_Toe_Touches'],
    steps: [
  ...
  'Standing Towel Triceps Extension': Exercise(
    name: 'Standing Towel Triceps Extension',
    muscleGroup: 'Arms',
    imageIds: ['Standing_Towel_Triceps_Extension'],
    steps: [
  ...
  'Standing Two-Arm Overhead Throw': Exercise(
    name: 'Standing Two-Arm Overhead Throw',
    muscleGroup: 'Shoulders',
    imageIds: ['Standing_Two-Arm_Overhead_Throw'],
    steps: [
  ...
  'Step-up with Knee Raise': Exercise(
    name: 'Step-up with Knee Raise',
    muscleGroup: 'Legs',
    imageIds: ['Step-up_with_Knee_Raise'],
    steps: [
  ...
  'Stiff-Legged Barbell Deadlift': Exercise(
    name: 'Stiff-Legged Barbell Deadlift',
    muscleGroup: 'Legs',
    imageIds: ['Stiff-Legged_Barbell_Deadlift'],
    steps: [
  ...
  'Stiff-Legged Dumbbell Deadlift': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['Stiff-Legged_Dumbbell_Deadlift'],
    steps: [
  ...
  'Stiff Leg Barbell Good Morning': Exercise(
    ...
    muscleGroup: 'Back',
    imageIds: ['Stiff_Leg_Barbell_Good_Morning'],
    steps: [
      'This exercise is best performed inside a squat rack for safety purposes. To begin, first set the bar on a rack that best matches your height. Once the correct height is chosen and the bar is loaded, step under the bar and place the back of your shoulders (slightly below the neck) across it.',
      'Hold on to the bar using both arms at each side and lift it off the rack by first pushing with your legs and at the same time straightening your torso.',
  ...
  'Straight-Arm Dumbbell Pullover': Exercise(
    name: 'Straight-Arm Dumbbell Pullover',
    muscleGroup: 'Chest',
    imageIds: ['Straight-Arm_Dumbbell_Pullover'],
    steps: [
      'Place a dumbbell standing up on a flat bench.',
      'Ensuring that the dumbbell stays securely placed at the top of the bench, lie perpendicular to the bench (torso across it as in forming a cross) with only your shoulders lying on the surface. Hips should be below the bench and legs bent with feet firmly on the floor. The head will be off the bench as well.',
  ...
  'Straight-Arm Pulldown': Exercise(
    ...
    muscleGroup: 'Back',
    imageIds: ['Straight-Arm_Pulldown'],
    steps: [
  ...
  'Straight Bar Bench Mid Rows': Exercise(
    ...
    muscleGroup: 'Back',
    imageIds: ['Straight_Bar_Bench_Mid_Rows'],
    steps: [
  ...
  'Straight Raises on Incline Bench': Exercise(
    ...
    muscleGroup: 'Shoulders',
    imageIds: ['Straight_Raises_on_Incline_Bench'],
    steps: [
      'Place a bar on the ground behind the head of an incline bench.',
  ...
  'Stride Jump Crossover': Exercise(
    name: 'Stride Jump Crossover',
    muscleGroup: 'Legs',
    imageIds: ['Stride_Jump_Crossover'],
    steps: [
      'Stand to the side of a box with your inside foot on top of it, close to the edge.',
      'Begin by swinging the arms upward as you push through the top leg, jumping upward as high as possible. Attempt to drive the opposite knee upward.',
  ...
  'Sumo Deadlift with Bands': Exercise(
    name: 'Sumo Deadlift with Bands',
    muscleGroup: 'Legs',
    imageIds: ['Sumo_Deadlift_with_Bands'],
    steps: [
  ...
  'Sumo Deadlift with Chains': Exercise(
    name: 'Sumo Deadlift with Chains',
    muscleGroup: 'Legs',
    imageIds: ['Sumo_Deadlift_with_Chains'],
    steps: [
  ...
  'Supine One-Arm Overhead Throw': Exercise(
    name: 'Supine One-Arm Overhead Throw',
    muscleGroup: 'Core',
    imageIds: ['Supine_One-Arm_Overhead_Throw'],
    steps: [
  ...
  'Supine Two-Arm Overhead Throw': Exercise(
    ...
    muscleGroup: 'Core',
    imageIds: ['Supine_Two-Arm_Overhead_Throw'],
    steps: [
  ...
  'Suspended Fallout': Exercise(
    name: 'Suspended Fallout',
    muscleGroup: 'Core',
    imageIds: ['Suspended_Fallout'],
    steps: [
  ...
  'Suspended Reverse Crunch': Exercise(
    ...
    muscleGroup: 'Core',
    imageIds: ['Suspended_Reverse_Crunch'],
    steps: [
  ...
  'Suspended Row': Exercise(
    name: 'Suspended Row',
    muscleGroup: 'Back',
    imageIds: ['Suspended_Row'],
    steps: [
  ...
  'Suspended Split Squat': Exercise(
    name: 'Suspended Split Squat',
    muscleGroup: 'Legs',
    imageIds: ['Suspended_Split_Squat'],
    steps: [
  ...
  'T-Bar Row with Handle': Exercise(
    ...
    muscleGroup: 'Back',
    imageIds: ['T-Bar_Row_with_Handle'],
    steps: [
      'Position a bar into a landmine or in a corner to keep it from moving. Load an appropriate weight onto your end.',
  ...
  'The Straddle': Exercise(
    name: 'The Straddle',
    muscleGroup: 'Legs',
    imageIds: ['The_Straddle'],
    steps: [
  ...
  'Thigh Adductor': Exercise(
    name: 'Thigh Adductor',
    muscleGroup: 'Legs',
    imageIds: ['Thigh_Adductor'],
    steps: [
  ...
  'Trail Running/Walking': Exercise(
    name: 'Trail Running/Walking',
    muscleGroup: 'Legs',
    imageIds: ['Trail_Running_Walking'],
    steps: [
  ...
  'Tricep Dumbbell Kickback': Exercise(
    ...
    muscleGroup: 'Arms',
    imageIds: ['Tricep_Dumbbell_Kickback'],
    steps: [
  ...
  'Tricep Side Stretch': Exercise(
    name: 'Tricep Side Stretch',
    muscleGroup: 'Arms',
    imageIds: ['Tricep_Side_Stretch'],
    steps: [
  ...
  'Triceps Overhead Extension with Rope': Exercise(
    ...
    muscleGroup: 'Arms',
    imageIds: ['Triceps_Overhead_Extension_with_Rope'],
    steps: [
  ...
  'Triceps Pushdown - Rope Attachment': Exercise(
    ...
    muscleGroup: 'Arms',
    imageIds: ['Triceps_Pushdown_-_Rope_Attachment'],
    steps: [
  ...
  'Triceps Pushdown - V-Bar Attachment': Exercise(
    name: 'Triceps Pushdown - V-Bar Attachment',
    muscleGroup: 'Arms',
    imageIds: ['Triceps_Pushdown_-_V-Bar_Attachment'],
    steps: [
  ...
  'Two-Arm Dumbbell Preacher Curl': Exercise(
    name: 'Two-Arm Dumbbell Preacher Curl',
    muscleGroup: 'Arms',
    imageIds: ['Two-Arm_Dumbbell_Preacher_Curl'],
    steps: [
  ...
  'Two-Arm Kettlebell Clean': Exercise(
    ...
    muscleGroup: 'Shoulders',
    imageIds: ['Two-Arm_Kettlebell_Clean'],
    steps: [
      'Place two kettlebells between your feet. To get in the starting position, push your butt back and look straight ahead.',
  ...
  'Two-Arm Kettlebell Jerk': Exercise(
    name: 'Two-Arm Kettlebell Jerk',
    muscleGroup: 'Shoulders',
    imageIds: ['Two-Arm_Kettlebell_Jerk'],
    steps: [
  ...
  'Two-Arm Kettlebell Military Press': Exercise(
    name: 'Two-Arm Kettlebell Military Press',
    muscleGroup: 'Shoulders',
    imageIds: ['Two-Arm_Kettlebell_Military_Press'],
    steps: [
  ...
  'Two-Arm Kettlebell Row': Exercise(
    ...
    muscleGroup: 'Back',
    imageIds: ['Two-Arm_Kettlebell_Row'],
    steps: [
  ...
  'Underhand Cable Pulldowns': Exercise(
    ...
    muscleGroup: 'Back',
    imageIds: ['Underhand_Cable_Pulldowns'],
    steps: [
  ...
  'Upper Back-Leg Grab': Exercise(
    name: 'Upper Back-Leg Grab',
    muscleGroup: 'Legs',
    imageIds: ['Upper_Back-Leg_Grab'],
    steps: [
  ...
  'Upright Row - With Bands': Exercise(
    name: 'Upright Row - With Bands',
    muscleGroup: 'Back',
    imageIds: ['Upright_Row_-_With_Bands'],
    steps: [
  ...
  'V-Bar Pullup': Exercise(
    name: 'V-Bar Pullup',
    muscleGroup: 'Back',
    imageIds: ['V-Bar_Pullup'],
    steps: [
  ...
  'Weighted Ball Hyperextension': Exercise(
    ...
    muscleGroup: 'Back',
    imageIds: ['Weighted_Ball_Hyperextension'],
    steps: [
  ...
  'Weighted Ball Side Bend': Exercise(
    ...
    muscleGroup: 'Core',
    imageIds: ['Weighted_Ball_Side_Bend'],
    steps: [
  ...
  'Weighted Sit-Ups - With Bands': Exercise(
    name: 'Weighted Sit-Ups - With Bands',
    muscleGroup: 'Core',
    imageIds: ['Weighted_Sit-Ups_-_With_Bands'],
    steps: [
  ...
  'Wide-Grip Barbell Bench Press': Exercise(
    ...
    muscleGroup: 'Chest',
    imageIds: ['Wide-Grip_Barbell_Bench_Press'],
    steps: [
  ...
  'Wide-Grip Decline Barbell Bench Press': Exercise(
    name: 'Wide-Grip Decline Barbell Bench Press',
    muscleGroup: 'Chest',
    imageIds: ['Wide-Grip_Decline_Barbell_Bench_Press'],
    steps: [
  ...
  'Wide-Grip Decline Barbell Pullover': Exercise(
    ...
    muscleGroup: 'Chest',
    imageIds: ['Wide-Grip_Decline_Barbell_Pullover'],
    steps: [
  ...
  'Wide-Grip Lat Pulldown': Exercise(
    ...
    muscleGroup: 'Back',
    imageIds: ['Wide-Grip_Lat_Pulldown'],
    steps: [
      'Sit down on a pull-down machine with a wide bar attached to the top pulley. Make sure that you adjust the knee pad of the machine to fit your height. These pads will prevent your body from being raised by the resistance attached to the bar.',
  ...
  'Wide-Grip Pulldown Behind The Neck': Exercise(
    name: 'Wide-Grip Pulldown Behind The Neck',
    muscleGroup: 'Back',
    imageIds: ['Wide-Grip_Pulldown_Behind_The_Neck'],
    steps: [
      'Sit down on a pull-down machine with a wide bar attached to the top pulley. Make sure that you adjust the knee pad of the machine to fit your height. These pads will prevent your body from being raised by the resistance attached to the bar.',
      'Grab the bar with the palms facing forward using the prescribed grip. Note on grips: For a wide grip, your hands need to be spaced out at a distance wider than your shoulder width. For a medium grip, your hands need to be spaced out at a distance equal to your shoulder width and for a close grip at a distance smaller than your shoulder width.',
  ...
  'Wide-Grip Rear Pull-Up': Exercise(
    name: 'Wide-Grip Rear Pull-Up',
    muscleGroup: 'Back',
    imageIds: ['Wide-Grip_Rear_Pull-Up'],
    steps: [
      'Grab the pull-up bar with the palms facing forward using a wide grip.',
  ...
  'Wide-Grip Standing Barbell Curl': Exercise(
    ...
    muscleGroup: 'Arms',
    imageIds: ['Wide-Grip_Standing_Barbell_Curl'],
    steps: [
  ...
  'Wide Stance Barbell Squat': Exercise(
    ...
    muscleGroup: 'Legs',
    imageIds: ['Wide_Stance_Barbell_Squat'],
    steps: [
      'This exercise is best performed inside a squat rack for safety purposes. To begin, first set the bar on a rack that best matches your height. Once the correct height is chosen and the bar is loaded, step under the bar and place the back of your shoulders (slightly below the neck) across it.',
      'Hold on to the bar using both arms at each side and lift it off the rack by first pushing with your legs and at the same time straightening your torso.',
  ...
  'Wide Stance Stiff Legs': Exercise(
    name: 'Wide Stance Stiff Legs',
    muscleGroup: 'Legs',
    imageIds: ['Wide_Stance_Stiff_Legs'],
    steps: [
  ...
  'World\'s Greatest Stretch': Exercise(
    name: 'World\'s Greatest Stretch',
    muscleGroup: 'Legs',
    imageIds: ['Worlds_Greatest_Stretch'],
    steps: [
  ...
  'Wrist Rotations with Straight Bar': Exercise(
    ...
    muscleGroup: 'Arms',
    imageIds: ['Wrist_Rotations_with_Straight_Bar'],
    steps: [
  ...
  'Zercher Squats': Exercise(
    name: 'Zercher Squats',
    muscleGroup: 'Legs',
    imageIds: ['Zercher_Squats'],
    steps: [
  ...
  'Zottman Preacher Curl': Exercise(
    name: 'Zottman Preacher Curl',
    muscleGroup: 'Arms',
    imageIds: ['Zottman_Preacher_Curl'],
    steps: [
